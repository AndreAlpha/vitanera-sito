...
| `constraints`                  | I vincoli materiali. **Non vuoto**, è un test. Cambiano di rado: vedi sotto.                                                                                                                                                   |
| `thresholds`                   | Le soglie dichiarate dalle letture, messe su una scala. **Non vuoto**, è un test. Si riallineano a ogni pubblicazione: vedi sotto.                                                                                             |
