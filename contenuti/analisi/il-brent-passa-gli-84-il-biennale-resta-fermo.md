...
titolo: "Il Brent passa gli 84, il biennale resta fermo"
occhiello: "Correlazioni · Una gamba su due"
sommario: "Il greggio arriva a 86,11 dollari, più 3,1%: sulla serie di questo archivio sono circa 84,7, e la soglia dichiarata il 5 agosto è caduta per la prima volta. L’altra metà della regola no — il biennale è a 4,22% e non si è mosso. A muoversi è il decennale, che tocca 4,696%: non è la Fed, è la parte lunga."
pubblicata: "2026-08-10T17:15:00+02:00"
autore: "Vitanera"
minutiLettura: 5
certezza: "alta"
categorie: ["correlazioni", "obbligazioni", "petrolio", "usa"]
argomenti: ["Soglie", "Curva dei rendimenti", "Premio a termine", "Hormuz", "Biennale"]
...
_Correlazioni · Una gamba su due_

Il greggio arriva a 86,11 dollari, più 3,1%: sulla serie di questo archivio sono circa 84,7, e la soglia dichiarata il 5 agosto è caduta per la prima volta. L’altra metà della regola no — il biennale è a 4,22% e non si è mosso. A muoversi è il decennale, che tocca 4,696%: non è la Fed, è la parte lunga.
...
Alta sui fatti: sono tutti prezzi osservati e riferiti dalle agenzie nella stessa finestra, compreso il massimo intraday del decennale. Media sulla lettura, perché la distinzione fra un irripidimento da premio a termine e una riprezzatura del percorso dei tassi si regge su una sola seduta e su movimenti di pochi punti base; una lettura del biennale a poche ore di distanza può cambiarla. Bassa, e va detto, sulla conversione fra le due serie del Brent: il superamento degli 84 dollari è ricavato applicando la variazione percentuale alla chiusura di venerdì di questo archivio, e settanta centesimi di margine stanno dentro l’errore del metodo.
