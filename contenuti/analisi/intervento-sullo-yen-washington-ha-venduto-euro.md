...
titolo: "Sullo yen Washington ha venduto euro, non dollari"
occhiello: "Valute · Struttura dell’intervento"
sommario: "Il coordinamento fra Stati Uniti e Giappone è confermato, ma la gamba americana dell’operazione non era in dollari: secondo il Financial Times Washington ha venduto euro. Cambia il significato dell’intervento per il dollaro, e con esso uno dei fattori rialzisti dell’oro."
pubblicata: "2026-08-03T15:00:00+02:00"
autore: "Vitanera"
minutiLettura: 4
certezza: "media"
...
_Valute · Struttura dell’intervento_
...
Il coordinamento fra Giappone e Stati Uniti a sostegno dello yen è confermato. La precisazione che arriva ora riguarda però un dettaglio tecnico che ne cambia il senso: la parte americana dell’operazione non sarebbe stata fatta vendendo dollari, ma vendendo euro. Lo ha riportato il Financial Times e una fonte operativa lo ha confermato a Reuters.

> **I dettagli ufficiali non sono ancora usciti** (warn)
>
> Il Tesoro statunitense e la Federal Reserve di New York non hanno pubblicato i dettagli dell’operazione. La ricostruzione è giornalistica e va trattata come tale: solida abbastanza da cambiare la lettura, non abbastanza da chiudere la questione.

## Perché la valuta venduta cambia tutto

Nella prima ricostruzione l’intervento sembrava indicare una volontà americana di indebolire il dollaro: se Washington vende dollari per comprare yen, il messaggio al mercato è che un dollaro più debole non le dispiace. La vendita di euro dice l’opposto. Gli Stati Uniti vogliono sostenere lo yen senza provocare un calo generalizzato del biglietto verde, anche per non alimentare ulteriormente l’inflazione interna.

È una distinzione che vale più dell’importo dell’operazione. Un intervento contro il dollaro e un intervento a spese dell’euro producono lo stesso effetto su USD/JPY e due effetti opposti sul Dollar Index.

## Che cosa cambia mercato per mercato

**La lettura rivista**

- **Dollaro** (bear) — Potrebbe stabilizzarsi o recuperare, soprattutto contro l’euro: è la valuta che ha fatto da contropartita all’intervento.
- **Oro** (bear) — Perde parte della spinta che stava ricevendo da un DXY debole. Il canale valutario, che era il sostegno più recente, si assottiglia.
- **Treasury** (bull) — Impatto neutrale o leggermente favorevole: la struttura scelta evita vendite massicce di titoli statunitensi.
- **Petrolio** — Nessun effetto diretto. Resta guidato dal dossier Iran-Hormuz, che non ha registrato sviluppi nello stesso intervallo.

_Deduzioni tratte dalla struttura dell’operazione così come è stata riportata, non movimenti già osservati._

## Il ruolo della BCE

L’uso dell’euro sarebbe stato scelto proprio per tenere l’intervento concentrato sullo yen. Resta aperta la domanda su chi abbia fornito quegli euro, e qui conviene essere precisi: di una partecipazione diretta della BCE non c’è notizia. È noto soltanto che la Banca centrale europea sarebbe stata in contatto con la Fed.

> **Un contatto non è una partecipazione** (warn)
>
> Se la BCE avesse preso parte all’operazione, la portata sarebbe molto maggiore: significherebbe un coordinamento a tre e non a due. Allo stato non risulta, ed è una differenza da non dare per colmata in attesa di conferme.

## Interpretazione aggiornata

Il bias su XAU/USD passa da moderatamente rialzista a neutrale con lieve inclinazione rialzista. Petrolio e rendimenti in discesa continuano a sostenere l’oro, e sono le due gambe che reggono ancora la lettura. Quella che viene a mancare è la terza: l’intervento sullo yen non può più essere considerato la prova di una volontà americana di indebolire tutto il dollaro.

> **Nota** — La parte solida di questa lettura è il coordinamento, confermato; l’utilizzo dell’euro è riportato dalla stampa e in attesa dei documenti ufficiali; l’effetto su XAU/USD è una deduzione che va verificata sui prezzi. La prossima verifica utile è dopo l’apertura americana.
...
Alta sul coordinamento fra Stati Uniti e Giappone, che è confermato; medio-alta sull’utilizzo dell’euro, riportato dal Financial Times e confermato a Reuters da una fonte operativa ma non ancora dai documenti ufficiali; media sull’impatto per XAU/USD, che è una deduzione e non un fatto osservato.

## Prossimo appuntamento

**Dopo l’apertura americana** — Prima verifica su dollaro e oro
