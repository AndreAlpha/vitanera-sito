...
titolo: "Il petrolio inverte bruscamente: Bessent apre su Hormuz"
occhiello: "Geopolitica · Ipotesi di riapertura"
sommario: "Brent e WTI passano dal recupero a un calo di circa il 4% dopo le parole del segretario al Tesoro statunitense: un’intesa per riaprire lo stretto potrebbe arrivare oggi o mercoledì. Per l’oro il canale che si apre è quello dell’inflazione attesa, non quello del rifugio."
pubblicata: "2026-08-04T15:10:00+02:00"
autore: "Vitanera"
minutiLettura: 4
certezza: "alta"
...
_Geopolitica · Ipotesi di riapertura_
...
Il quadro si è capovolto nel giro di poche ore. Brent e WTI, che nella mattinata stavano ampliando il recupero, sono passati a un calo di circa il 4%. Non è un aggiustamento: è l’inversione del movimento che aveva dominato l’intera giornata.

**Dove sono i prezzi**

| Voce | Valore | Nota |
| --- | --- | --- |
| Brent | ≈ 80,66 $ | Circa −4%, dal recupero della mattina |
| WTI | ≈ 76,76 $ | Circa −4% |

_Valori citati dalle fonti al momento della scrittura, non quotazioni in tempo reale._

## Che cosa ha girato il mercato

La svolta è arrivata dopo le dichiarazioni del segretario al Tesoro statunitense Scott Bessent, secondo cui un’intesa per riaprire lo Stretto di Hormuz potrebbe arrivare già oggi o mercoledì. Anche il Qatar ha riferito che starebbe circolando una bozza di accordo, con Oman e Pakistan coinvolti nella mediazione.

È la prima volta in questa vicenda che a parlare di tempi non è una parte sola: alle parole americane si affianca una conferma indiretta dal Golfo. Resta il fatto che la controparte iraniana, finora, ha smentito ogni volta.

## Perché conta per XAU/USD

Il crollo del petrolio riduce il rischio di una nuova accelerazione dell’inflazione americana. È il canale che nelle ultime sedute stava lavorando contro l’oro, e che ora comincia a girare dall’altra parte.
...
> **Il contrappeso viene dalla stessa notizia** (bear)
>
> Una vera distensione con l’Iran ridurrebbe anche la domanda di oro come bene rifugio. I due effetti nascono dallo stesso fatto e tirano in direzioni opposte: per questo la reazione netta di XAU/USD può restare inizialmente contenuta.

## Che cosa manca perché sia un accordo

Un accordo non è ancora confermato. Al momento esistono dichiarazioni americane e segnali dei mediatori, ma i flussi di petrolio attraverso Hormuz restano limitati e la situazione marittima non è tornata alla normalità. La distanza fra un’intesa annunciata come possibile e uno stretto che torna a funzionare è tutta lì. Dal lato della Federal Reserve, intanto, non risultano nuove comunicazioni monetarie rilevanti.

## Interpretazione aggiornata

Il bias passa da neutrale-ribassista a neutrale con lieve inclinazione rialzista, soprattutto attraverso il canale inflazione-rendimenti. La lettura diventerebbe più favorevole all’oro se il petrolio restasse sotto pressione e il JOLTS risultasse debole, facendo scendere insieme rendimenti e dollaro.

> **Nota** — Dichiarazioni e livelli di prezzo provengono dalle agenzie citate nel testo. I riferimenti numerici servono a rendere verificabile il ragionamento: non sono quotazioni in tempo reale né obiettivi.
...
Alta sull’inversione del petrolio, che è un prezzo osservabile; media sulla conclusione diplomatica, perché esistono dichiarazioni e segnali dei mediatori ma non un accordo, e media sull’impatto finale sull’oro, che dipende da quale dei due canali prevale.

## Prossimo appuntamento

**Oggi alle 16:00** — JOLTS di giugno
