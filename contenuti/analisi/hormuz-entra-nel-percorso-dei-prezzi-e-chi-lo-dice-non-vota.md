...
titolo: "Hormuz entra nel percorso dei prezzi, e chi lo dice non vota"
occhiello: "Fed · Una funzione di reazione che dipende da altri"
sommario: "La presidente ad interim della Fed di Atlanta dice che il percorso futuro dell’inflazione dipenderà molto dal Medio Oriente. Nella stessa giornata Teheran ribadisce che lo Stretto resta chiuso finché gli Stati Uniti non accettano le sue condizioni. Le due frasi vanno lette insieme."
pubblicata: "2026-08-11T19:25:00+02:00"
autore: "Vitanera"
minutiLettura: 8
certezza: "alta"
categorie: ["fed", "medio-oriente", "mercato-immobiliare", "oro"]
argomenti: ["Venable", "Voto", "Vendite di case", "ADP settimanale", "Asta triennale"]
...
impostazione:
  ...
  forza: "bassa"
  orizzonte: "medio"
  regime: "Tre informazioni nuove e nessuna che sposti il numero che questo archivio ha dichiarato tre ore fa come misura di riferimento. Le vendite di case esistenti scendono per il secondo mese di fila, a 4,06 milioni annualizzati da 4,13 con meno 1,7%, ma restano appena sopra il consenso di 4,05: attività debole senza sorpresa. L’occupazione privata settimanale rilevata da ADP rallenta a più 8.300 da più 11.000, su una serie molto volatile e senza consenso pubblicato. E dalla Fed di Atlanta arriva una presa di posizione restrittiva sull’inflazione da una presidente ad interim che quest’anno non vota al FOMC. Il biennale, che è la misura scelta, non si è mosso; l’oro sta nell’area 4.380-4.390 dollari, il Dollar Index a 99,81 e la probabilità di un rialzo a settembre al 48%. La direzione sui giorni resta quindi dov’era, e ci resta per la regola scritta prima e non per assenza di notizie."
prossimoAppuntamento:
  quando: "Mercoledì 12 agosto, 14:30 italiane"
  titolo: "Indice dei prezzi al consumo statunitense di luglio"
  dettaglio: "Il consenso riportato è di più 0,1% mensile e più 3,4% annuo sul dato principale, più 0,2% mensile e più 2,5% annuo su quello di fondo. È il dato che mette alla prova proprio la frase della Fed di Atlanta: se la componente energetica comincia a farsi vedere, il canale Medio Oriente-prezzi smette di essere una previsione e diventa una misura. Alle 19:00 dello stesso giorno l’asta del decennale, giovedì quella del trentennale, e giovedì alle 14:30 i prezzi alla produzione."
fonti:
  - testata: "Reuters"
  - testata: "National Association of Realtors"
    titolo: "Existing Home Sales, luglio"
  - testata: "Kitco"
  - testata: "Forex Factory"
    titolo: "ADP Weekly Employment Change"
  - testata: "U.S. Department of the Treasury"
    titolo: "Calendario delle aste"
sorgente: "src/app/core/data/articles/hormuz-entra-nel-percorso-dei-prezzi-e-chi-lo-dice-non-vota.ts"
impronta: "052212d02ca75876"
---

# Hormuz entra nel percorso dei prezzi, e chi lo dice non vota

_Fed · Una funzione di reazione che dipende da altri_

La presidente ad interim della Fed di Atlanta dice che il percorso futuro dell’inflazione dipenderà molto dal Medio Oriente. Nella stessa giornata Teheran ribadisce che lo Stretto resta chiuso finché gli Stati Uniti non accettano le sue condizioni. Le due frasi vanno lette insieme.
...
Alta sul fondamento principale, che è una diffusione ufficiale confermata da Reuters e dall’associazione nazionale degli agenti immobiliari, e sulle dichiarazioni della Fed di Atlanta, riportate da Reuters. Più bassa su una parte: la rilevazione settimanale ADP arriva da un aggregatore di calendario, non ha un consenso pubblicato e appartiene a una serie molto più volatile di quella mensile, quindi è citata come indizio e non come misura. Media sulla lettura, e la ragione è dichiarata: sostenere che una dichiarazione senza voto pesi meno di una con voto è un criterio di questo archivio applicato a un caso nuovo, non una regolarità misurata. Il risultato dell’asta a tre anni non compare qui perché al momento della scrittura non era pubblicato, e un numero non ancora uscito non si stima.
...
Tre informazioni nuove e nessuna che sposti il numero che questo archivio ha dichiarato tre ore fa come misura di riferimento. Le vendite di case esistenti scendono per il secondo mese di fila, a 4,06 milioni annualizzati da 4,13 con meno 1,7%, ma restano appena sopra il consenso di 4,05: attività debole senza sorpresa. L’occupazione privata settimanale rilevata da ADP rallenta a più 8.300 da più 11.000, su una serie molto volatile e senza consenso pubblicato. E dalla Fed di Atlanta arriva una presa di posizione restrittiva sull’inflazione da una presidente ad interim che quest’anno non vota al FOMC. Il biennale, che è la misura scelta, non si è mosso; l’oro sta nell’area 4.380-4.390 dollari, il Dollar Index a 99,81 e la probabilità di un rialzo a settembre al 48%. La direzione sui giorni resta quindi dov’era, e ci resta per la regola scritta prima e non per assenza di notizie.

## Fonti consultate

- **Reuters**
- **National Association of Realtors** — Existing Home Sales, luglio
- **Kitco**
- **Forex Factory** — ADP Weekly Employment Change
