...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    name: 'Oro spot',
    value: '4.330,46 $',
    change: 'meno 0,3%, dopo un minimo di 4.322,28',
    tone: 'warn',
    icon: 'coin',
    note: 'Rilevazioni di lunedì 10 agosto: fra 4.340 e 4.350 all’apertura, minimo a 4.322,28 alle quattro del mattino — meno 0,5%, che Reuters attribuisce a prese di profitto dopo il massimo da sette settimane di venerdì — e 4.330,46 in mattinata europea. Il balzo del 2,4% di venerdì viene conservato ma non esteso di un dollaro, e i massimi a circa 4.372 non sono mai stati riavvicinati. La parte che informa non è il calo, che è ordinario dopo una seduta così, ma il contesto in cui avviene: dollaro vicino al minimo da due mesi, decennale in discesa al 4,637%, biennale fermo, greggio in rialzo dell’1,4% sull’incertezza di Hormuz. Manca del tutto la coppia che affonda il metallo — dollaro forte e rendimenti in salita — e il metallo scende lo stesso. Attenzione alla serie: il contratto future scambia una sessantina di dollari sopra lo spot, e tutte le soglie qui sono sullo spot.',
  },
  {
    symbol: 'SUSSIDI',
  ...
  },
  {
    ...
    value: '4,206%',
    change: 'praticamente fermo, da 4,204%',
    tone: 'bull',
    icon: 'arrow-flat',
    note: 'È la scadenza dove si prezza per prima una decisione di settembre, ed è la metà della regola dichiarata il 5 agosto: oltre il 4,25%, con il Brent sopra gli 84 dollari, il canale dei tassi torna a lavorare contro il metallo. Lunedì mattina resta quattro punti base sotto quella tacca e non l’ha mai avvicinata, mentre il greggio saliva dell’1,4%. È il dato che tiene in piedi la lettura: finché il premio energetico non arriva alla curva breve, l’escalation su Hormuz resta un problema di offerta di greggio e non un problema per l’oro.',
  },
  {
    symbol: 'US10Y',
    name: 'Treasury a 10 anni',
    value: '4,637%',
    change: 'in discesa, dopo essere risalito verso il 4,67% in sessione asiatica',
    tone: 'bull',
    icon: 'arrow-down',
    note: 'Percorso a due tempi nella stessa notte: in sessione asiatica risale verso il 4,67% — Reuters rileva 4,673% — dal 4,658% precedente, poi torna a scendere fino al 4,637% nella mattinata europea. Resta sei punti base sotto la tacca di logoramento del 4,68% e sette sotto quella del 4,70% che invaliderebbe la lettura. La direzione conta più del livello: un decennale che scende mentre il greggio sale dell’1,4% dice che il mercato obbligazionario non sta ancora prezzando il premio energetico come inflazione attesa, ed è esattamente il canale da cui questa storia può girarsi contro il metallo. Da tenere d’occhio questa settimana, perché arrivano 125 miliardi di titoli fra martedì e giovedì.',
  },
  {
    symbol: 'US30Y',
  ...
  },
  {
    ...
    name: 'Dollar Index',
    value: '≈ 99,6',
    change: 'escursione strettissima, 99,57-99,65, vicino al minimo da due mesi',
    tone: 'bull',
    icon: 'arrow-flat',
    note: 'Lunedì il dollaro non fa nulla, e il nulla è informativo. In una sessione in cui il greggio sale dell’1,4% su una crisi di approvvigionamento, il biglietto verde non attrae la fuga verso la qualità: resta vicino al minimo da due mesi in un’escursione di otto centesimi. È la ragione per cui il calo dell’oro va letto come consolidamento e non come inversione — la combinazione che affonda davvero il metallo è dollaro forte insieme a rendimenti in salita, e stamattina nessuna delle due gambe c’è. La soglia da guardare resta quota 100: sopra, con il biennale oltre il 4,25%, la lettura cambia natura.',
  },
  {
    symbol: 'PETROLIO',
    name: 'Greggio Brent',
    value: '84,38 $',
    change: 'più 1%, dopo un massimo di 84,79 all’apertura',
    tone: 'bear',
    icon: 'arrow-up',
    note: 'Lunedì 10 agosto il premio si forma e questa volta resta: apertura a 84,79 dollari con più 1,44%, 84,32 in sessione asiatica, 84,38 in mattinata europea; il WTI passa da 79,29 a 78,75. Il motore indicato da Reuters è l’incertezza sulla riapertura dello Stretto, e il numero che lo spiega è il conteggio dei transiti, sceso a due navi venerdì. Serve però una precisazione che cambia una conclusione: queste quotazioni implicano una chiusura di venerdì intorno a 83,55 — 84,79 con più 1,44% dà una base di 83,59 — mentre la serie usata da questo archivio dal 5 agosto ha chiuso a 82,21, ed è su quella che sono fissate le tacche degli 80, 82 e 84 dollari. Applicando la stessa variazione percentuale, il Brent di questa scheda vale circa 83 dollari: sopra gli 82 che invaliderebbero la lettura geopolitica, sotto gli 84 oltre i quali il greggio smette di sostenere il metallo. Nessuna delle due tacche è stata toccata, e leggere il 84,79 dell’apertura come il superamento della soglia sarebbe un errore di un dollaro e mezzo.',
  },
  {
    symbol: 'GOLFO',
