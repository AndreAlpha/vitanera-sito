...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    name: 'Greggio Brent',
    value: '88,67 $',
    change: 'più 1,1% in serata; circa 87,3 sulla serie di questo archivio',
    tone: 'bull',
    icon: 'arrow-down',
