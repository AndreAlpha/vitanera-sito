...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    name: 'Oro spot',
    value: '4.360,97 $',
    change: 'più 2,84%, massimo 4.371,89, da 4.240,69 di chiusura',
    tone: 'bull',
    icon: 'coin',
    note: 'Quotazione spot delle 14:56 del 7 agosto, non in tempo reale. Il rialzo vale 120 dollari e arriva quasi tutto dopo il rapporto occupazionale delle 14:30. Il fatto diagnostico non è il rialzo ma la divergenza: nella stessa ora il Brent scende dell’1,01%, quindi il metallo sale mentre il premio geopolitico si sgonfia, ed è la firma di un movimento sui tassi e non sul rifugio. Attenzione alla serie: il contratto future scambia una sessantina di dollari più in alto, e le soglie di questa scheda sono sullo spot.',
  },
  {
    symbol: 'SUSSIDI',
  ...
  },
  {
    ...
    tone: 'bear',
    icon: 'bank',
    note: 'Il rapporto occupazionale ha spostato in mezz’ora quello che sette prese di posizione restrittive non erano riuscite a muovere in una settimana: la probabilità di un rialzo alla riunione del 16 settembre passa dal 55,1% delle 14:20 al 41,7%, cioè dall’altra parte della metà. Non è una sfumatura, è il cambio del caso base: fino a stamattina lo scenario più probabile era che la Fed alzasse, adesso è che resti ferma. Sulla riunione del 9 dicembre il rialzo scende dall’82,7% al 73,8%, sommando le fasce sopra quella corrente: il mercato non lo esclude, lo sposta più avanti.',
  },
  {
    symbol: 'PCE',
  ...
  },
  {
    ...
    value: '4,162%',
    change: 'meno 8,3 punti base, minimo di giornata 4,158%',
    tone: 'bull',
    icon: 'arrow-down',
    note: 'È la scadenza dove si prezza per prima una decisione di settembre, ed è quella che si è mossa di più: meno 8,3 punti base da 4,245%, con un minimo di 4,158%. Due giorni fa lo stesso rendimento era a mezzo punto base dal 4,25% che avrebbe invalidato una lettura rialzista sull’oro; adesso è quasi nove punti base sotto quella soglia. Quando è il biennale a guidare il movimento, e non il decennale, si sta guardando la politica monetaria attesa e non il premio a termine.',
  },
  {
    symbol: 'US10Y',
    name: 'Treasury a 10 anni',
    value: '4,616%',
    change: 'meno 5,4 punti base, minimo 4,601% dal massimo di 4,690%',
    tone: 'bull',
    icon: 'arrow-down',
  ...
  },
  {
    ...
    name: 'Dollar Index',
    value: '99,345',
    change: 'meno 0,46%, minimo di giornata 99,280, da 99,808',
    tone: 'bull',
    icon: 'arrow-down',
  ...
  },
  {
    ...
    name: 'Greggio Brent',
    value: '81,66 $',
    change: 'meno 1,01%, minimo 81,52 dal massimo di 84,40',
    tone: 'warn',
    icon: 'arrow-down',
    note: 'Il greggio scende mentre l’oro sale del 2,84%, ed è questa divergenza — non il rialzo del metallo — il fatto che qualifica la giornata: se fosse una corsa al rifugio i due prezzi salirebbero insieme, come lunedì e martedì. Il premio di rischio si sta sgonfiando sulla base fragile che l’analisi del 6 agosto aveva indicato, cioè una bozza parlamentare iraniana che dopo un giorno è ancora «una proposta iniziale» in commissione. Resta comunque due dollari sopra i 79,45 di due giorni fa: ridotto, non annullato.',
  },
  {
    symbol: 'GOLFO',
