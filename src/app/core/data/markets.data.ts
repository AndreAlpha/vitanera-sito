...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    name: 'Oro spot',
    value: '4.381,04 $',
    change: 'meno 0,62% sulla chiusura di 4.408,59; massimo notturno 4.449,71',
    tone: 'warn',
    icon: 'coin',
