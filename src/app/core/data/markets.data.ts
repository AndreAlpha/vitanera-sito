...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    name: 'Oro spot',
    value: '≈ 4.333 $',
    change: 'meno 0,2%, dopo un minimo di 4.322,28 nella notte',
    tone: 'warn',
    icon: 'coin',
    note: 'Rilevazioni di lunedì 10 agosto: fra 4.340 e 4.350 all’apertura, minimo a 4.322,28 alle quattro del mattino — meno 0,5%, che Reuters attribuisce a prese di profitto dopo il massimo da sette settimane di venerdì — poi 4.330,46 in mattinata europea e circa 4.333 nel pomeriggio. Il balzo del 2,4% di venerdì viene conservato ma non esteso di un dollaro, e i massimi a circa 4.372 non sono mai stati riavvicinati. La parte che informa è il contesto, e nel pomeriggio è cambiato: per tutta la mattina il metallo non aveva approfittato di un contorno favorevole — dollaro vicino al minimo da due mesi, decennale in discesa — mentre adesso quel contorno non c’è più, perché dollaro, biennale e decennale salgono insieme al greggio. Restano trentatré dollari sopra la soglia dei 4.300 che invaliderebbe la lettura. Attenzione alla serie: il contratto future scambia una sessantina di dollari sopra lo spot, e tutte le soglie qui sono sullo spot.',
  },
  {
    symbol: 'SUSSIDI',
  ...
  },
  {
    ...
    value: '3,50%-3,75%',
    change: 'rialzo di settembre al 44%, contro il 67% di una settimana fa',
    tone: 'bull',
    icon: 'bank',
    note: 'Il numero regge il fine settimana. Dopo il rapporto occupazionale era passato dal 55,1% delle 14:20 al 41,7%, risalendo poi al 43,7% in chiusura; lunedì i futures lo collocano al 44% secondo Reuters, mentre il Financial Times indica circa il 45% da un precedente 60%. Le due rilevazioni non coincidono al decimo perché non usano la stessa base, ma dicono la stessa cosa: il rialzo di settembre resta in minoranza e il caso base è una Fed ferma. È l’unica gamba solida rimasta alla lettura rialzista, ed è anche il numero che l’indice dei prezzi di mercoledì può ribaltare in mezz’ora. Resta un’aspettativa ricavata dai contratti a termine, non una decisione.',
  },
  {
    symbol: 'PCE',
  ...
  },
  {
    ...
    value: '4,228%',
    change: 'più 2,4 punti base, da 4,204%',
    tone: 'bear',
    icon: 'arrow-up',
    note: 'È la scadenza dove si prezza per prima una decisione di settembre, ed è la metà della regola dichiarata il 5 agosto: oltre il 4,25%, con il Brent sopra gli 84 dollari, il canale dei tassi torna a lavorare contro il metallo. Per tutta la mattina era rimasto fermo a 4,206% mentre il greggio saliva, ed era quella la separazione fra i due canali; nel pomeriggio si è mosso con lui, a 4,228%. Il movimento è di due punti base e mezzo, cioè poco, e preso da solo sarebbe rumore. Quello che lo rende diverso è la contemporaneità con greggio, dollaro e decennale: quattro strumenti che girano nella stessa ora e tutti contro il metallo. Mancano due punti base alla tacca, ed è la prima volta che entrambe le gambe della regola si avvicinano insieme.',
  },
  {
    symbol: 'US10Y',
    name: 'Treasury a 10 anni',
    value: '4,664%',
    change: 'in leggerissimo rialzo, dopo il 4,637% della mattinata',
    tone: 'warn',
    icon: 'arrow-up',
    note: 'Percorso a tre tempi nella stessa giornata: in sessione asiatica risale verso il 4,67% — Reuters rileva 4,673% — dal 4,658% precedente, scende al 4,637% nella mattinata europea, e nel pomeriggio torna a 4,664% mentre il greggio accelera. Resta un punto e mezzo sotto la tacca di logoramento del 4,68% e quasi quattro sotto il 4,70% che invaliderebbe la lettura. La direzione conta più del livello, e nel pomeriggio si è girata: un decennale che sale insieme al greggio è il mercato obbligazionario che comincia a prezzare il premio energetico come inflazione attesa, cioè il canale da cui questa storia si gira contro il metallo. Da tenere d’occhio, perché fra martedì e giovedì arrivano 125 miliardi di titoli del Tesoro.',
  },
  {
    symbol: 'US30Y',
  ...
  },
  {
    ...
    name: 'Greggio Brent',
    value: '≈ 85 $',
    change: 'circa più 2%; sulla serie di questo archivio, circa 83,85',
    tone: 'bear',
    icon: 'arrow-up',
    note: 'Lunedì 10 agosto il premio si forma e per la prima volta in una settimana non si sgonfia entro la seduta: apertura a 84,79 dollari con più 1,44%, 84,32 in sessione asiatica, 84,38 in mattinata europea, ritorno verso gli 85 nel pomeriggio con circa più 2%. Il motore indicato da Reuters resta l’incertezza sulla riapertura dello Stretto, e il numero che lo spiega è il conteggio dei transiti, sceso a due navi venerdì. Serve una precisazione che cambia una conclusione: queste quotazioni implicano una chiusura di venerdì intorno a 83,55, mentre la serie usata da questo archivio dal 5 agosto ha chiuso a 82,21, ed è su quella che sono fissate le tacche degli 80, 82 e 84 dollari. Applicando la stessa variazione percentuale, il Brent di questa scheda vale circa 83,85: quindici centesimi sotto la tacca degli 84 oltre la quale il greggio smette di sostenere il metallo. Non è stata toccata, ma è la volta che ci è andata più vicino — e questa volta il biennale si è mosso insieme al greggio, che è l’altra metà della stessa regola.',
  },
  {
    symbol: 'GOLFO',
