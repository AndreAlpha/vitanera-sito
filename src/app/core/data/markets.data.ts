...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    name: 'Greggio Brent',
    value: '79,08 $',
    change: 'ancora in calo, WTI 74,69 $',
    tone: 'bull',
    icon: 'arrow-down',
    note: 'È sceso sotto i 79,34 di ieri sera e sotto gli 80,87 toccati dopo il missile houthi, nonostante nel frattempo sia arrivata una minaccia iraniana esplicita agli impianti del Golfo. Pesano la trattativa su Hormuz e 2,5 milioni di barili in più nelle scorte americane. Sopra gli 82 dollari l’effetto inflazionistico tornerebbe a pesare sull’oro più della domanda di rifugio.',
  },
  {
    symbol: 'GOLFO',
