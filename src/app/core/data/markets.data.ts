...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  {
    ...
    name: 'Oro spot',
    value: '≈ 4.258',
    change: 'in consolidamento dopo l’allungo',
    tone: 'gold',
    icon: 'coin',
    note: 'Livello citato al momento della scrittura, non una quotazione in tempo reale. Il metallo non si è mosso né sui sussidi né sulla produttività: sta aspettando il rapporto occupazionale. Il supporto tecnico indicato dalla fonte resta l’area 4.160.',
  },
  {
    symbol: 'SUSSIDI',
  ...
  },
  {
    ...
    value: '≈ 4,64%',
    change: 'un punto base sui dati del pomeriggio',
    tone: 'warn',
    icon: 'arrow-flat',
    note: 'Da circa 4,65% a 4,64% dopo sussidi e produttività: la discesa che la catena del greggio giustificava è frenata dal Brent che risale. Il 4,68% è la tacca in cui la lettura comincia a logorarsi, il 4,70% quella che la invalida.',
  },
  {
    symbol: 'US30Y',
  ...
  },
  {
    ...
    name: 'Greggio Brent',
    value: 'sopra 80 $',
    change: 'in risalita da 79,08, WTI verso 76 $',
    tone: 'bear',
    icon: 'arrow-up',
    note: 'La soglia di logoramento fissata ieri mattina a 80 dollari è stata superata in ventiquattro ore, e non per una minaccia nuova ma per l’assenza di una conferma definitiva sull’intesa Iran-Oman. Sopra gli 82 dollari l’effetto inflazionistico tornerebbe a pesare sull’oro più della domanda di rifugio: fra gli 80 e gli 82 la lettura si logora senza rompersi.',
  },
  {
    symbol: 'GOLFO',
