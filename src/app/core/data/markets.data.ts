...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    name: 'Oro spot',
    value: '4.304,72 $',
    change: 'più 1,51%, massimo 4.316,57, da 4.240,69 di chiusura',
    tone: 'bull',
    icon: 'coin',
  ...
  },
  {
    ...
    value: '4,677%',
    change: 'massimo 4,690% stamattina, da 4,670 di chiusura',
    tone: 'bear',
    icon: 'arrow-up',
    note: 'La tacca di logoramento del 4,68% è stata superata alla chiusura del 6 agosto e di nuovo stamattina nel massimo, ma il valore corrente è tornato appena sotto: la lettura sull’oro si sta consumando senza rompersi, e restano poco più di due punti base al 4,70% che la invalida. La spinta resta energetica e non monetaria — il biennale è fermo a 4,243% e la probabilità di un rialzo a settembre non si muove dal 55,1%.',
  },
  {
    symbol: 'US30Y',
  ...
  },
  {
    ...
    name: 'Greggio Brent',
    value: '83,14 $',
    change: 'minimo di giornata 82,96: mai sotto gli 82',
    tone: 'bear',
    icon: 'arrow-up',
