...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    name: 'Oro spot',
    value: '≈ 4.335 $',
    change: 'meno 0,2% nella seduta, dopo un minimo di 4.322,28 nella notte',
    tone: 'warn',
    icon: 'coin',
    note: 'Rilevazioni di lunedì 10 agosto: fra 4.340 e 4.350 all’apertura, minimo a 4.322,28 alle quattro del mattino — meno 0,5%, che Reuters attribuisce a prese di profitto dopo il massimo da sette settimane di venerdì — poi 4.330,46 in mattinata, circa 4.333 nel primo pomeriggio e circa 4.335 in chiusura di giornata europea. Il balzo del 2,4% di venerdì viene conservato ma non esteso, e i massimi a circa 4.372 non sono mai stati riavvicinati. La cosa che informa di più è però quanto il metallo ha assorbito senza cedere: nella sola giornata il Brent è salito del 3,1% fino a 86,11 dollari, il decennale ha toccato 4,696% e il dollaro si è rafforzato, e l’oro è finito dove era otto ore prima. Restano trentacinque dollari sopra la soglia dei 4.300 che invaliderebbe la lettura. Attenzione alla serie: il contratto future scambia una sessantina di dollari sopra lo spot, e tutte le soglie qui sono sullo spot.',
  },
  {
    symbol: 'SUSSIDI',
  ...
  },
  {
    ...
    value: '≈ 4,68%',
    change: 'massimo intraday 4,696%, dal 4,637% della mattinata',
    tone: 'bear',
    icon: 'arrow-up',
    note: 'Percorso a quattro tempi nella stessa giornata: 4,673% in sessione asiatica, 4,637% nella mattinata europea, 4,664% nel primo pomeriggio e infine circa 4,68% con un massimo di 4,696%. Ha così raggiunto la tacca di logoramento del 4,68% ed è arrivato a quattro millesimi dal 4,70% che invaliderebbe la lettura. La cosa da guardare non è il livello ma il confronto con la scadenza breve: il biennale nella stessa finestra è fermo a 4,22%. Una curva che si irripidisce invece di traslare non sta prezzando un percorso dei tassi diverso — sta chiedendo più premio per detenere carta lunga. Per l’oro le due cose pesano su orizzonti diversi: il percorso dei tassi si vede in giornata, il premio a termine sul mese. È la ragione per cui il metallo ha assorbito. Da tenere d’occhio, perché fra martedì e giovedì arrivano 125 miliardi di titoli del Tesoro proprio su quella parte della curva.',
  },
  {
    symbol: 'US30Y',
