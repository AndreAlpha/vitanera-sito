...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  {
    ...
    name: 'Oro spot',
    value: '≈ 4.199,8',
    change: 'oltre +3%, massimo dal 22 giugno',
    tone: 'gold',
    icon: 'coin',
    note: 'Livello citato nell’analisi, non una quotazione in tempo reale. Si è fermato venti centesimi sotto una cifra tonda: come i 4.100 e l’area 4.150-4.170 prima di lui, il numero conta perché ci si accumulano ordini, non da solo.',
  },
  {
    symbol: 'ARGENTO',
    name: 'Argento spot',
    value: 'oltre +4%',
    change: 'sale più dell’oro',
    tone: 'bull',
    icon: 'spark',
    note: 'È il dettaglio che qualifica il movimento: quando il metallo più piccolo e più volatile corre più dell’oro, di solito si sta guardando un afflusso di ordini sull’intero comparto, non una riprezzatura dei tassi.',
  },
  {
    symbol: 'ADP',
  ...
  },
  {
    ...
    value: '≈ 4,62%',
    change: 'vicino ai minimi della settimana',
    tone: 'warn',
    icon: 'arrow-flat',
    note: 'È basso, ma è fermo: sta al 4,60-4,62% da metà giornata e non lo hanno spostato né l’ADP né il piano del Tesoro né i due interventi restrittivi. Il 4,70% resta la soglia che invaliderebbe la lettura.',
  },
  {
    symbol: 'US30Y',
