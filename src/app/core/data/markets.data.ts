...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  {
    ...
    tone: 'warn',
    icon: 'percent',
    note: 'Il record non è nuovo: questo archivio lo aveva pubblicato il 4 agosto al 5,25% con il titolo «Rendimenti a 30 anni di nuovo sui massimi dal 2007», e dal 2007 a oggi sono diciannove anni. Nuovo è il resto del quadro. Quel giorno il livello serviva a spiegare perché l’oro restasse fermo poco sopra i 4.062 dollari — il mercato obbligazionario assorbiva la domanda rifugio, era il ragionamento — e oggi lo stesso rendimento, tre punti base più su, convive con un oro a 4.386,13, cioè più 8% in una settimana. Fra il 4 e l’11 agosto sono successe molte cose che non c’entrano con la curva, quindi i trecentoventiquattro dollari non sono opera del trentennale; ma la conclusione stretta regge, e va registrata: quel livello di rendimento da solo non basta a tenere fermo il metallo, e il 4 agosto era stato scritto come se bastasse. Delle tre cose che la parte lunga prezzava allora — inflazione persistente, fabbisogno del Tesoro, credibilità restrittiva della Fed — una è caduta il giorno dopo con un rifinanziamento trimestrale che non ha allargato le aste lunghe, e la terza è misurata dal biennale, che non si muove. Resta la prima, da sola.',
  },
  {
  ...
  },
  {
    ...
    name: 'Oro spot',
    value: '4.386,13 $',
    change: 'risalito dai 4.365,65 di metà mattina; massimo di giornata 4.434,84',
    tone: 'warn',
    icon: 'coin',
    note: 'Giornata in tre tempi. Nella sessione asiatica il metallo sale fino a 4.434,84 dollari, il più alto dal 5 giugno, con i futures statunitensi a 4.492,60; in mattinata europea restituisce quasi settanta dollari fino a 4.365,65, sotto i 4.372 che erano la prima condizione di invalidazione scritta qui alle 9:45; nel pomeriggio risale a 4.371,92 e poi a 4.386,13. La parte che conta è la terza, perché è avvenuta contro il vento: nella stessa finestra il trentennale è andato vicino al 5,28% e il Brent ha toccato i 90 dollari. È forza relativa, ed è misurabile. Non basta però ad alzare la direzione, perché la prova richiesta era il recupero dei 4.400 con il decennale sopra il 4,70%, e sono mancati quattordici dollari: una soglia che vale solo quando conviene non è una soglia. Restano ottantasei dollari sopra i 4.300 che invaliderebbero la lettura di fondo. Attenzione alla serie: il contratto future scambia una sessantina di dollari sopra lo spot, e tutte le soglie qui sono sullo spot.',
  },
  {
    symbol: 'SUSSIDI',
  ...
  },
  {
    ...
    value: '4,237%',
    change: 'due millesimi in meno, e tredici sotto il 4,25% della regola del 5 agosto',
    tone: 'bull',
    icon: 'arrow-flat',
  ...
  },
  {
    ...
    value: '≈ 4,71%',
    change: 'massimo di seduta a 4,736%, il più alto della fase, poi il rientro',
    tone: 'bear',
    icon: 'arrow-up',
    note: 'Salita a tappe in due giorni: 4,637% nella mattinata di lunedì, poi 4,664%, poi circa 4,70% con un massimo di 4,703% in serata, 4,712% nella sessione asiatica dell’11 agosto, 4,721% in mattinata europea e infine un massimo di 4,736% nel pomeriggio, prima del rientro a circa 4,71%. La differenza rispetto a ieri non è il livello ma la permanenza: il rendimento non tocca più la soglia del 4,70%, ci sta sopra da un giorno intero. Quello che il decennale non ha fatto conta però quanto quello che ha fatto: non ha portato con sé il biennale, fermo a 4,237%, e non ha portato giù l’oro, che nella stessa finestra è risalito a 4.386,13. La condizione dichiarata chiede il 4,75% con l’oro sotto i 4.350, e nessuna delle due gambe è arrivata. Fra martedì e giovedì arrivano 125 miliardi di titoli del Tesoro proprio su questa parte della curva.',
  },
  {
    symbol: 'DXY',
    name: 'Dollar Index',
    value: '≈ 99,80',
    change: 'fermo per la terza rilevazione consecutiva, sotto quota 100',
    tone: 'bull',
    icon: 'arrow-flat',
  ...
  },
  {
    ...
    name: 'Greggio Brent',
    value: '87,51 $',
    change: 'dopo un massimo di 90,03; circa 86,1 e 88,6 sulla serie di questo archivio',
    tone: 'warn',
    icon: 'arrow-down',
    note: 'La giornata ha una forma netta: 89,12 dollari in mattinata europea, poi 89,81 con il WTI a 84,28 — massimi dal 31 luglio — poi il test di quota 90 con un massimo di 90,03 e il WTI a 84,61, e da lì il rientro a 87,51 e 82,09. Reuters attribuisce la discesa a segnali descritti come più costruttivi nei colloqui fra Oman e Iran sulla gestione dello Stretto, precisando che un accordo sostanziale non c’è: è l’ottavo annuncio di distensione in una settimana, ed è il primo a cui il prezzo paga quasi tre punti percentuali. Il fatto va contro la lettura tenuta qui — che il mercato avesse smesso di pagare per la distensione annunciata — e con una giornata sola non si separa dall’ipotesi alternativa, cioè che il rientro sia il fallimento di un test a novanta dollari e l’annuncio la storia attaccata sopra a cose fatte. Il numero che le distingue non è il prezzo, è il conteggio dei transiti. Il percorso della fase resta lo stesso e va tenuto insieme: apertura di lunedì a 84,79 dollari, 86,11 nel tardo pomeriggio, 87,40-87,72 in serata a seconda della fonte, 88,09 nella sessione asiatica. I due motori che l’avevano prodotto sono ancora lì — le richieste di risarcimento fra Stati Uniti e Iran diventate due e simmetriche, e l’attacco con droni che ha ritardato la ripartenza della raffineria Aramco di Jazan — e nessuno dei due è stato tolto da quanto detto oggi al tavolo dell’Oman. Serve la conversione fra le serie: queste quotazioni implicano una chiusura di venerdì intorno a 83,55, mentre la serie usata qui dal 5 agosto ha chiuso a 82,21, ed è su quella che sono fissate le tacche degli 80, 82 e 84 dollari. Applicando la stessa variazione il massimo vale circa 88,6 e il rientro circa 86,1: oltre due dollari sopra la tacca anche nel punto più basso. Resta caduta una gamba sola della regola del 5 agosto — l’altra chiede un biennale sopra il 4,25%, e oggi il biennale è sceso a 4,237%, cioè a tredici millesimi.',
  },
  {
    symbol: 'GOLFO',
