...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    name: 'Oro spot',
    value: '4.312,33 $',
    change: 'più 1,69%, massimo 4.327,70, da 4.240,69 di chiusura',
    tone: 'bull',
    icon: 'coin',
  ...
  },
  {
    ...
    value: '4,664%',
    change: 'minimo di giornata 4,653%, dal massimo di 4,690%',
    tone: 'warn',
    icon: 'arrow-down',
  ...
  },
  {
    ...
    name: 'Dollar Index',
    value: '99,752',
    change: 'minimo di giornata 99,720, sempre sotto quota 100',
    tone: 'bull',
    icon: 'arrow-flat',
  ...
  },
  {
    ...
    name: 'Greggio Brent',
    value: '82,03 $',
    change: 'meno 0,56%, minimo di giornata 81,66',
    tone: 'warn',
    icon: 'arrow-down',
