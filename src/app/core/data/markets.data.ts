...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  {
    ...
    value: '4,683%',
    change: '39 mld $; contro il 4,580% dell’asta precedente',
    tone: 'bear',
    icon: 'print',
    note: 'È la prova sulla parte lunga della curva che questo archivio rimandava da tre giorni, ed è l’unica che contava davvero: la tensione di tutta la settimana si è concentrata lì, e finora era stata sondata solo con una scadenza a tre anni. Il confronto che regge senza riserve è quello con l’asta precedente sulla stessa scadenza: il Tesoro paga oggi dieci punti base e mezzo in più di un mese fa. Il rendimento di aggiudicazione è anche sopra il 4,673% a cui il titolo scambia sul secondario, ma quel confronto va preso con cautela, perché è una rilevazione di quaranta minuti dopo e non il quotato all’istante in cui si sono chiuse le offerte: senza quel numero non si può parlare di coda, e senza il rapporto fra domanda e offerta non si sa quanta domanda si sia presentata. Nessuno dei due era disponibile al momento della scrittura. Il contrasto con ieri resta comunque leggibile: la scadenza a tre anni si era aggiudicata al 4,291% con un rapporto domanda-offerta di 2,71 contro una media di circa 2,64, cioè con domanda più forte del solito. Le due sedute insieme dicono che la parte breve trova compratori e la parte lunga li trova a un prezzo che sale — che è esattamente la divergenza su cui questa scheda lavora da tre giorni.',
  },
  {
