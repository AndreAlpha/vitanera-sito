...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    value: '55,6',
    change: 'atteso 54,0, precedente 53,3',
    tone: 'bear',
    icon: 'gauge',
    note: 'Sorpresa nettamente positiva sulla crescita industriale, con l’occupazione tornata sopra 50 a 52,8. È il dato che toglie all’oro l’inclinazione rialzista.',
  },
  {
    symbol: 'ISM PREZZI',
  ...
  },
  {
    ...
    tone: 'warn',
    icon: 'dollar',
    note: 'Tre spinte al recupero — la struttura dell’intervento sullo yen, l’ISM a 55,6 e i rendimenti — che però restano attese: finché non si vedono sui prezzi, la lettura resta neutrale e non ribassista sull’oro.',
  },
  {
    symbol: 'PETROLIO',
    name: 'Greggio Brent',
