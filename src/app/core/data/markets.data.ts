...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  {
    ...
    value: '≈ 102,20 $',
    change: 'per barile, sopra i cento per la prima volta; gasolio al dettaglio ≈ 5,47 $/gallone',
    tone: 'bear',
    icon: 'factory',
    note: 'È la misura di un’ipotesi che questo archivio aveva scritto il 18 agosto alle 08:40 senza poterla verificare: se il collo di bottiglia si sposta dall’estrazione alla trasformazione, benzina e gasolio restano cari anche con il barile fermo, e la soglia dei 90 dollari sul Brent misura meno di quanto si credesse. Le cause dichiarate sono tre e si sommano: flussi mediorientali compromessi dallo Stretto, offerta russa ridotta dopo gli attacchi alle raffinerie, e scorte americane di distillati ai livelli di agosto più bassi dal 1996, con una lavorazione mondiale di luglio circa cinque milioni di barili al giorno sotto quella di un anno prima. Per il metallo il segno dipende da un altro numero: finché l’inflazione di pareggio resta al 2,27% su cinque anni, il rincaro entra nei rendimenti come costo reale invece che come inflazione attesa, ed è la forma peggiore.',
  },
  {
    symbol: 'CHIUSURA 18/8 USA',
    name: 'Chiusura della fase americana di XAU/USD nella seduta del 18 agosto',
    value: '4.344,82 $',
    change: '−1,61%; futures di dicembre ≈ 4.396,30, −0,6%; rimbalzo asiatico a 4.342,33, +0,2%',
    tone: 'gold',
    icon: 'coin',
    note: 'La correzione si è estesa oltre l’area 4.365 registrata a fine giornata europea: il metallo ha perso anche i 4.350, dopo aver perso i 4.381 nel pomeriggio. Il rimbalzo notturno vale due decimi di punto percentuale contro una seduta persa per quasi il 2%, e alle 09:06 del 19 agosto il prezzo è tornato attorno a 4.337,6. È la terza seduta consecutiva in cui il metallo non usa un rientro dei rendimenti, e la quarta occasione in cui non usa un risk-off azionario.',
  },
  {
    symbol: 'TRANSITI 18/8',
    name: 'Transiti di navi commodity attraverso lo Stretto di Hormuz, martedì 18 agosto',
    value: '6 navi',
    change:
      'contro 9 il giorno prima e una media recente di ≈ 11; prima del conflitto 130-140 al giorno',
    tone: 'bear',
    icon: 'flow',
    note: 'La composizione conta più del conteggio, e va nella stessa direzione: fra le navi entrate c’era una petroliera molto grande vuota — cioè una nave che va a caricare, non che porta greggio — insieme a due tanker minori, mentre in uscita risultano due navi di prodotti raffinati e una post-Panamax. Nessun grande carico di greggio, nessun gas liquefatto. Le principali compagnie di shipping cinesi continuano a tenere le proprie petroliere lontane sia da Hormuz sia dal Bab el-Mandeb, dove i transiti del fine settimana salgono a trenta da diciannove ma non risulta tracciata alcuna spedizione petrolifera saudita.',
  },
  {
    symbol: 'IRAQ 1/9',
    name: 'Meccanismi irakeni di esportazione che aggirano lo Stretto di Hormuz',
    value: 'contratti dal 1° settembre',
    change: 'sesto adattamento al blocco in cinque giorni; volumi non dichiarati',
    tone: 'bull',
    icon: 'compass',
    note: 'Baghdad ha approvato nuovi meccanismi per esportare greggio evitando il passaggio, con i primi contratti attesi dal 1° settembre. Preso da solo è marginale; messo in fila con gli altri cinque — sostituzione turca del greggio russo con Brasile e Guyana, obiettivi indiani di produzione domestica di GPL, consegne saudite nave-nave a Fujairah, carichi Aramco ripresi dentro lo Stretto, deviazione delle compagnie cinesi — descrive un mercato che sta rendendo il collo di bottiglia meno insostituibile. Per l’oro questo taglia la gamba energetica del premio e lascia intatta quella del rifugio, il che nella configurazione attuale arriva dal lato giusto. Manca la cosa che lo renderebbe misurabile: un volume.',
  },
  {
    symbol: 'MISSILI HORMUZ',
    name: 'Lancio iraniano di due missili balistici verso il traffico marittimo, dichiarato dagli Emirati',
    value: 'intercettati',
    change: 'caduti in mare; nessuna nave colpita, nessun barile perso; WTI +0,5%',
    tone: 'warn',
    icon: 'shield',
    note: 'È un’arma nuova per questa serie di attacchi — i precedenti in archivio riguardano droni, armi leggere e un missile contro una petroliera saudita vicino a Yanbu, sul Mar Rosso — e un effetto nullo sull’offerta. La domanda che questo archivio pone a ogni attacco è quanta capacità toglie: due missili caduti in mare ne tolgono zero, ed è la ragione per cui il greggio li ha registrati con mezzo punto percentuale. L’intercettazione taglia inoltre in due sensi: alza il livello dichiarato del conflitto ma dimostra che le difese funzionano, e una deterrenza che funziona toglie premio invece di darlo. La fonte è il ministero della Difesa di una parte in causa, senza conferma indipendente.',
  },
  {
    symbol: 'ASTA 20 ANNI',
    name: 'Collocamento del titolo del Tesoro americano a vent’anni, 19 agosto',
    value: '16 mld $',
    change: 'alle 19:00 italiane, un’ora prima dei verbali del FOMC delle 20:00',
    tone: 'warn',
    icon: 'scale',
    note: 'Arriva dopo due collocamenti su scadenze lunghe aggiudicati entrambi sopra il quotato di mercato: il decennale da 42 miliardi il 12 agosto al 4,683% contro un secondario a 4,673%, e il trentennale da 25 miliardi il 13 agosto al 5,216% contro 5,212% alla chiusura delle offerte, in entrambi i casi con domanda pari o sotto la propria media. Due casi non sono una serie statistica, ma sono gli unici due della fase in cui la parte lunga è tesa. Il numero da cercare non è il rendimento di aggiudicazione ma il suo scarto dal quotato al momento della chiusura delle offerte, ed è la distinzione che questo archivio ha già sbagliato una volta il 13 agosto, correggendola il giorno dopo.',
  },
  {
    symbol: 'DAZI CANADA',
    name: 'Sospensione per tre giorni dei dazi statunitensi al 50% su merci canadesi',
    value: '≈ 20 mld $',
    change: 'entrata in vigore rinviata di tre giorni; accordo dichiarato ma non pubblicato',
    tone: 'warn',
    icon: 'globe',
    note: 'Il rinvio è un atto e si può verificare; l’accordo è per ora una dichiarazione senza testo. L’effetto sul metallo è quasi nullo — l’unica reazione osservabile è un modesto rafforzamento del dollaro canadese — ma la notizia tocca il canale misurato il 18 agosto: i prezzi all’importazione di luglio sono scesi dello 0,4% complessivo trascinati dai carburanti a meno 7,2%, mentre al netto dei carburanti salivano dello 0,4% sul mese e del 4,5% sull’anno. Un dazio agisce sulla seconda metà o sulla prima a seconda di che cosa colpisce, e l’elenco delle merci non è pubblicato: senza quello non si può dire quale delle due la sospensione tocchi.',
  },
  {
    symbol: 'PAREGGIO 10A',
    name: 'Inflazione di pareggio a dieci anni ricavata dai titoli indicizzati americani',
    value: '≈ 2,30%',
    change: 'a cinque anni ≈ 2,27%; con il nominale a ≈ 4,708% il rendimento reale è ≈ 2,41%',
    tone: 'warn',
    icon: 'gauge',
    note: 'È il primo numero di questo tipo che compare in archivio, e chiude una domanda aperta da una settimana. Il Tesoro americano emette sulla stessa scadenza titoli nominali e titoli indicizzati: la differenza fra i due rendimenti è l’inflazione che chi compra sta effettivamente pagando per coprirsi. Con il decennale nominale ai massimi da gennaio 2025 e il trentennale ai massimi dal 2007, un pareggio fermo appena sopra l’obiettivo del 2% dice che il rialzo dei rendimenti lunghi non è inflazione attesa ma premio a termine, rischio fiscale e offerta di debito. Per il metallo è la risposta peggiore delle due possibili: quello che sale è il rendimento reale, e un dato macroeconomico debole non lo abbassa, perché fa scendere insieme il rendimento nominale e l’inflazione attesa lasciando la differenza dov’era.',
  },
  {
    symbol: 'CHIUSURA 18/8',
    name: 'Chiusura di XAU/USD nella seduta del 18 agosto 2026',
    value: '4.364,90 $',
    change: '−1,1%; futures di dicembre regolati a 4.420,60, −1,2%',
    tone: 'gold',
    icon: 'coin',
    note: 'La seduta si chiude vicino ai minimi, dopo un’apertura sopra i 4.426 dollari e un minimo intraday attorno a 4.378. Il primo supporto indicato al mattino, 4.381 dollari, è stato attraversato nel pomeriggio, e la fascia successiva indicata è quella fra 4.350 e 4.320. Quello che rende la chiusura informativa non è la taglia del calo ma il contesto: è avvenuta durante un risk-off azionario, con gli indici americani vicini ai minimi di due settimane, e mentre i rendimenti rientravano dai massimi. Due sostegni simultanei ignorati nella stessa seduta.',
  },
  {
    symbol: 'MASSIMI E RIENTRO',
    name: 'Rendimenti dei Treasury nella seduta del 18 agosto 2026',
    value: '10Y 4,7478% → ≈ 4,708%',
    change: '30Y 5,3371% → 5,2868%, massimo dal 2007; 2Y ≈ 4,20%',
    tone: 'bear',
    icon: 'chart',
    note: 'Il decennale ha toccato il 4,7478%, massimo da gennaio 2025 e due millesimi di punto sotto la soglia del 4,75% dichiarata il 17 agosto sera, per poi rientrare a circa 4,708%. Il trentennale ha toccato il 5,3371%, massimo dal 2007, chiudendo a 5,2868%. Sono circa quattro e cinque punti base restituiti, e l’oro non ha recuperato nulla: è il rifiuto che dà il contenuto alla giornata. Il biennale resta molto più basso, attorno al 4,20%, e conferma che il problema non è una riprezzatura della banca centrale ma il premio a termine sulla parte lunga.',
  },
  {
    symbol: 'ARAMCO 12-16/8',
    name: 'Ripresa parziale dei carichi di greggio sauditi dai terminali dentro lo Stretto',
    value: '3 navi, ≈ 6 mln barili',
    change:
      'Juaymah e Ras Tanura; ≈ 1,2 mln b/g nella finestra; Sidi Kerir ≈ 670.000 b/g ad agosto',
    tone: 'warn',
    icon: 'flow',
    note: 'Tre petroliere da circa due milioni di barili ciascuna hanno caricato fra il 12 e il 16 agosto dai terminali di Juaymah e Ras Tanura, dopo la sospensione seguita agli attacchi contro le navi; altre sarebbero in attesa più avanti nel mese. Aramco continua inoltre a offrire greggio in Asia con trasferimenti nave-nave al largo di Fujairah e per rotte alternative via Yanbu e Sidi Kerir, da cui sono attesi circa 670.000 barili al giorno in agosto, molto meno della capacità pre-blocco. Sommate, le due voci danno meno di due milioni di barili al giorno di flusso misurabile, contro un traffico che prima del conflitto contava 130-140 navi al giorno nello Stretto. La data conta quanto la notizia: i carichi sono avvenuti mentre il Brent saliva da 87,07 a 90,87 dollari, quindi non spiegano il prezzo e non ne spiegheranno il rientro. È una ricostruzione di agenzia da dati di tracciamento, non un comunicato della compagnia.',
  },
  {
    symbol: 'VENDITE IN CORSO',
    name: 'Indice delle vendite immobiliari in corso statunitensi, luglio 2026',
    value: '−2,3% m/m',
    change: 'atteso fra +0,1% e +0,3%; indice 71,2 da 72,9; annuo −2,2%; giugno rivisto a −4,8%',
    tone: 'bull',
    icon: 'layers',
    note: 'È la sorpresa più ampia della giornata: il consenso attendeva un segno più e il dato esce a meno 2,3%. L’indice scende al livello più basso da gennaio e il calo riguarda tutte e quattro le regioni americane, il che toglie ogni spiegazione locale. Sommando la revisione di giugno a meno 4,8% la caduta dei due mesi è del 7,0%, contro un meno 2,2% su base annua: il deterioramento è recente e concentrato. La serie conta contratti firmati e non transazioni concluse, quindi anticipa di uno o due mesi le vendite di case esistenti: è l’unica diffusione della giornata che non misura una finestra già chiusa.',
  },
  {
    symbol: 'GREGGIO 18/8',
    name: 'Regolamenti del greggio nella seduta del 18 agosto 2026',
    value: 'Brent 91,02 $',
    change: '+0,17%; WTI 84,94 $, +0,52%: massimi di chiusura dal 24 luglio',
    tone: 'bear',
    icon: 'basket',
    note: 'Terza seduta consecutiva sopra la soglia dei 90 dollari, che questo archivio segue da cinque letture come interruttore fra il canale del rifugio e quello dell’inflazione attesa. Rispetto ai massimi intraday oltre i 91,2 dollari il greggio ha restituito una parte del movimento, e la ragione è la ripresa parziale dei carichi sauditi insieme ai trasferimenti nave-nave a Fujairah e alle spedizioni non tracciate. Lo Stretto resta però fortemente compromesso, non sono previsti colloqui con Teheran, e la chiusura sopra i 91 dollari tiene in vita il rischio che i dati di inflazione di agosto siano molto diversi da quelli benigni di luglio.',
  },
  {
    symbol: 'CAPACITA IMPIANTI',
    name: 'Grado di utilizzo della capacità produttiva statunitense, luglio 2026',
    value: '76,3%',
    change: 'atteso 76,4%; giugno rivisto da 76,1% a 76,2%; media storica 79,4%',
    tone: 'bull',
    icon: 'dashboard',
    note: 'Il numero che il rapporto sulla produzione industriale porta accanto al dato principale, e che questo archivio non aveva mai pubblicato. Dice quanta parte degli impianti esistenti sta lavorando, e quindi se un rincaro delle materie prime può essere assorbito aumentando i volumi o deve essere girato sul prezzo finale. Con 3,1 punti di margine sulla media storica la risposta è la prima: se l’inflazione di agosto accelererà, non sarà per strozzature della capacità industriale interna, ma per il barile — cioè attraverso un canale su cui alzare i tassi è la risposta meno efficace. Come il dato principale, manca il consenso di un decimo e porta una revisione al rialzo sul mese precedente.',
  },
  {
