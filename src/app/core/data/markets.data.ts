...
export const MARKET_REFERENCES: readonly MarketReference[] = [
  ...
  },
  {
    ...
    value: '4,239%',
    change: 'undici millesimi sotto il 4,25% della regola del 5 agosto',
    tone: 'warn',
    icon: 'arrow-up',
    note: 'È la scadenza dove si prezza per prima una decisione di settembre, ed è la metà della regola dichiarata il 5 agosto: oltre il 4,25%, con il Brent sopra gli 84 dollari, il canale dei tassi torna a lavorare contro il metallo. Per due giorni è rimasto immobile fra il 4,204% e il 4,228% mentre il greggio superava la sua tacca, la probabilità di un rialzo a settembre guadagnava otto punti e il decennale saliva di sette: era il numero più importante proprio perché non si muoveva. Nella sessione asiatica dell’11 agosto arriva a 4,239%, cioè a undici millesimi dalla soglia, ed è la volta che ci è andato più vicino da quando la regola esiste. La cautela d’obbligo è che il mercato a pronti statunitense era chiuso per una festività giapponese: questa è l’ultima rilevazione disponibile e non un prezzo formato nella finestra. Se il biennale supera il 4,25% con il Brent dove sta, entrambe le gambe della regola cadono per la prima volta.',
  },
  {
    symbol: 'US10Y',
