...
export const OUTCOMES: readonly Outcome[] = [
  ...
  },
  {
    ...
    checkedAt: '2026-08-18T15:20:00+02:00',
    verdict: 'parziale',
    conditions: [
      {
        condition:
        ...
        triggered: false,
        evidence:
          'Il termine era venerdì 14 agosto. La probabilità di un rialzo a settembre è scesa al 33,0% nella mattina del 14 e poi al 29,3% dopo le vendite al dettaglio a meno 0,6%, minimo di questa fase, senza mai riavvicinare il 48%. Il crollo del 12 agosto era quindi una riprezzatura e non la reazione di mezz’ora al titolo.',
      },
      {
        condition:
      ...
      },
      {
        ...
        triggered: false,
        evidence:
          'Chiusura di venerdì 14 agosto a 4.376,59 dollari con più 0,59%, quattordici dollari sopra la soglia, in guadagno sulla giornata e sulla settimana dopo un massimo di 4.396,88. Il balzo seguito al dato non è stato restituito entro la settimana.',
      },
      {
        condition:
  ...
  },
  {
    ...
    checkedAt: '2026-08-19T09:12:00+02:00',
    verdict: 'parziale',
    conditions: [
      {
        condition: 'Una conferma ufficiale dei colloqui fra Stati Uniti e Iran.',
        triggered: false,
        evidence:
          'Nessuna conferma ufficiale è mai arrivata nelle due settimane successive, e le fonti dell’archivio registrano il contrario. Già l’analisi del 4 agosto alle 08:45 sulla nave colpita a Hormuz scrive che Washington sostiene che i contatti siano in corso mentre Teheran nega negoziati diretti e precisa che quelli con l’Oman riguardano soltanto la gestione dei passaggi marittimi, aggiungendo che nessuna delle due parti ha prodotto una conferma verificabile. L’analisi del 5 agosto alle 08:35 sui transiti a Hormuz ripete che l’Iran continua a negare negoziati diretti con Washington. L’unica dichiarazione in senso opposto è quella del presidente statunitense del 5 agosto alle 10:30 su una trattativa «durata tutto il giorno», che l’archivio classifica esplicitamente come parola di una parte sola, negata dalla controparte e senza fonte indipendente. Il 9 agosto l’analisi sul drone su Jazan riporta il ministro degli Esteri iraniano Abbas Araqchi che dice che Iran e Stati Uniti non stanno negoziando direttamente, che per ora si scambiano messaggi tramite intermediari e che Teheran non aprirà nuovi colloqui finché Washington continuerà a violare l’accordo provvisorio di giugno. L’8 agosto il portavoce delle Guardie Rivoluzionarie Mohebbi lega la riapertura all’accettazione americana delle condizioni iraniane. Il 17 agosto l’analisi sulla combinazione che si forma riferisce che Reuters parla di stallo completo della diplomazia fra Stati Uniti e Iran, e il 18 agosto l’analisi su Aramco che ricarica dentro lo Stretto cita Reuters che riporta Trump dichiarare che non sono previsti colloqui con l’Iran. La condizione non è scattata in nessun momento della finestra.',
      },
      {
        condition: 'Un accordo verificabile e non soltanto annunciato.',
        triggered: false,
        evidence:
          'Nessun accordo verificabile fra Stati Uniti e Iran è mai stato registrato, e il metro materiale scelto dall’archivio lo conferma numero per numero. Il 5 agosto il ministero degli Esteri iraniano annuncia che Iran e Oman hanno concordato le coordinate geografiche di una rotta, ma la dichiarazione congiunta resta in revisione e non arriva neanche il 6 agosto; l’8 agosto Araqchi dice che Iran e Oman sono «molto vicini» a un’intesa ma che la riapertura dipende da altre condizioni, fra cui una compensazione statunitense, e in ogni caso è un tavolo Iran-Oman, non Stati Uniti-Iran. Il conteggio dei transiti a Hormuz, l’unica misura di verifica adottata, resta fermo a otto navi contro le 130-140 al giorno dal 5 agosto, è ancora otto il 6 agosto dopo il sesto annuncio, vale 33 transiti in quattro giorni l’8 agosto, torna a otto il 12 agosto — il più basso dal 5 — e il 17 agosto l’analisi sul salto mancato registra zero navi commerciali nei dati Kpler domenica 16 agosto, contro cinque sabato e trentuno nel fine settimana precedente. L’unico documento firmato del periodo è il patto della Mecca del 7 agosto fra Arabia Saudita, Turchia e Pakistan, che non riguarda Stati Uniti e Iran. Il 18 agosto Teheran continua a dichiarare lo Stretto chiuso finché Washington non rispetterà le condizioni dell’accordo provvisorio. La condizione non è scattata.',
      },
      {
        condition:
        ...
        triggered: true,
        evidence:
          'Il calo e proseguito, ma non subito e non a lungo. Rispetto ai riferimenti dell’analisi (Brent 83,77 e WTI 80,34 alla chiusura di lunedi 3 agosto), alla riapertura il greggio e prima risalito: l’analisi delle 08:45 del 4 agosto (nave-colpita-nello-stretto-di-hormuz) da Brent 84,89 con circa piu 1,3% e WTI 81,11, e quella delle 12:35 (rischio-hormuz-si-paga-in-petrolio-e-rendimenti-non-in-oro) Brent 86,04 con circa piu 2,7% e WTI 82,06. Nella finestra indicata come prossimo appuntamento, la riapertura asiatica, la condizione era quindi smentita, non scattata. Il ribasso riparte nel pomeriggio e su una notizia diversa dalla minaccia, l’apertura di Bessent su Hormuz: l’analisi delle 15:10 registra Brent 80,66 e WTI 76,76 con circa meno 4%, quella delle 20:05 (oro-estende-il-rialzo-il-canale-e-quello-dei-tassi) Brent 80,47 e WTI 76,67, l’analisi del 5 agosto alle 08:35 (hormuz-non-ha-riaperto) Brent intorno a 79,6 e WTI 75,9, quella delle 10:30 (trump-dichiara-una-trattativa-durata-tutto-il-giorno) Brent 79,04 e WTI 75,19. Gli esiti in src/app/core/data/outcomes.data.ts confermano entrambi i passaggi, ciascuno sotto il proprio slug: sotto ’oro-estende-il-rialzo-il-canale-e-quello-dei-tassi’ (riga 2141) si legge «Il greggio si e stabilizzato senza rimbalzare: Brent intorno a 79,6 dollari da 80,47, WTI vicino a 75,9 da 76,67»; sotto ’hormuz-non-ha-riaperto-otto-navi-contro-130-al-giorno’ (riga 2074, esito alla riga 2095) si legge «Il greggio e sceso ancora invece di rimbalzare: Brent a 79,04 dollari da 79,6, WTI a 75,19 da 75,9». Il minimo cade il 6 agosto: l’analisi delle 08:40 (iran-minaccia-gli-impianti-del-golfo-il-greggio-scende) da Brent 79,08 e WTI 74,69 e scrive che e il terzo giorno di fila in cui una notizia di rischio non viene pagata dal prezzo, con una minaccia esplicita agli impianti energetici del Golfo arrivata sopra quel quadro e il greggio piu basso di prima; l’analisi delle 18:47 dello stesso giorno (il-brent-supera-gli-82-dollari-la-soglia-e-caduta) riporta un minimo di giornata a 78,55 e una chiusura precedente di 79,45. Dal massimo di 86,04 al minimo di 78,55 sono 7,49 dollari; rispetto agli 83,77 di riferimento il calo e di 5,22 dollari, circa il 6,2%. E il significato scritto nella condizione, un mercato che non da credito alla minaccia, e cade dentro l’orizzonte breve dichiarato. Va detto il limite: la prosecuzione dura poco piu di due sedute, perche gia alle 18:47 del 6 agosto il Brent risale a 82,74 da 79,45 e il movimento si inverte, fino a 90,87 in chiusura il 17 agosto e 91,23 il 18.',
      },
    ],
    what: 'Pubblicata il 4 agosto alle 00:10 con i riferimenti di chiusura di lunedì 3 agosto, Brent 83,77 dollari e WTI 80,34, l’analisi dava bias neutrale con rischio rialzista geopolitico. Alla riapertura il greggio prima è risalito — Brent 84,89 alle 08:45 e 86,04 alle 12:35 del 4 agosto — poi è crollato di circa il 4% dopo l’apertura di Bessent su Hormuz, a 80,66 alle 15:10, e ha continuato a scendere fino a 79,04 il 5 agosto, 79,08 la mattina del 6 con un minimo di giornata a 78,55: tre sedute in cui, come registra l’archivio il 6 agosto, «una notizia di rischio non viene pagata dal prezzo». Sul lato diplomatico nulla si è confermato: Teheran ha continuato a negare negoziati diretti (Araqchi, 9 agosto), i transiti a Hormuz sono rimasti otto navi contro le 130-140 al giorno fino ad azzerarsi domenica 16 agosto, e il 18 agosto Reuters riporta che Trump dichiara che non sono previsti colloqui con l’Iran, con il Brent a 91,23 dollari.',
  },
  {
    ...
    conditions: [
      {
        condition: 'Un chiarimento ufficiale che ridimensioni l’attacco.',
        triggered: false,
        evidence:
          'Nessun chiarimento ufficiale che ridimensioni l’attacco del 4 agosto compare in archivio: la parola ridimensiona ricorre in dodici analisi, ma sempre riferita ad altro (l’annuncio militare sospeso, l’importanza strategica dello Stretto secondo Bessent, i colloqui con l’Oman, il disavanzo federale di luglio), mai all’episodio del mercantile. I fatti datati vanno nella direzione opposta: l’analisi del 7 agosto alle 17:25 (quindici-navi-colpite-e-il-greggio-riparte) riporta la dichiarazione di ADNOC secondo cui quindici sue navi sono state colpite da missili o droni nello Stretto dall’inizio del conflitto, tre soltanto in quella settimana, con un morto e venti feriti, e il Brent che passa da 81,66 dollari con meno 1,01% delle 14:57 a 83,33 con piu 1,02%. L’analisi del 14 agosto alle 10:20 (sedici-attacchi-alle-navi-e-il-blocco-senza-scadenza) porta il conteggio ad almeno sedici attacchi dal 28 febbraio, e l’esito registrato su di essa il 15 agosto alle 09:20 aggiunge una terza nave ADNOC colpita venerdi secondo l’agenzia ufficiale emiratina WAM. La prova resta indiretta perche nessun documento dichiara esplicitamente che un chiarimento non e mai arrivato: si deduce dal fatto che la serie e stata contata e allungata invece che ridotta.',
      },
      {
        condition: 'Un accordo verificabile fra Stati Uniti e Iran.',
        triggered: false,
        evidence:
          'Nessun accordo verificabile fra Stati Uniti e Iran, e l’assenza e misurata piu volte con dei numeri. L’analisi del 4 agosto alle 18:25 riferisce da Reuters che i termini operativi non risultano concordati, perche l’Iran chiede di mantenere il controllo sul traffico in entrata e di essere informato su quello in uscita. L’esito dell’analisi del 5 agosto alle 08:35 archivia la condizione parallela con un no: nessun accordo firmato, Trump parla di trattativa molto positiva mentre l’Iran nega un’intesa imminente, e il conteggio dei transiti sta a otto navi contro le 130-140 al giorno di prima del conflitto. Il 5 agosto alle 19:15 le coordinate concordate sono fra Iran e Oman, non con Washington, e restano irrisolti i quattro punti che decidono se una nave passa; il 6 agosto alle 17:15 Teheran precisa che i colloqui con l’Oman non sono la riapertura. Il 18 agosto alle 08:40 Reuters riferisce solo di possibili contatti indiretti fra Washington e le Guardie Rivoluzionarie tramite un intermediario curdo, senza alcun accordo, mentre lunedi 17 agosto sono transitate sei navi commodity, tre in entrata e tre in uscita, nessuna petroliera grande e nessuna metaniera, contro una media a dieci giorni di undici. L’ultima rilevazione dell’archivio, il 18 agosto alle 19:25, chiude la questione: Trump dichiara che non sono previsti colloqui con l’Iran e Teheran mantiene lo Stretto chiuso finche Washington non rispettera le condizioni dell’accordo provvisorio di giugno, che e precedente a questa analisi e che l’Iran stesso considera violato. A quattordici giorni dalla pubblicazione l’accordo verificabile non esiste.',
      },
      {
        condition:
        ...
        triggered: true,
        evidence:
          'I minimi di riferimento sono quelli dell’analisi del 4 agosto alle 00:10, che dà il Brent a 83,77 dollari e il WTI a 80,34 dopo il crollo della seduta del 3 agosto, e l’analisi in esame delle 08:45 li vede risalire a 84,89 e 81,11. Il ritorno sui minimi è avvenuto nella stessa seduta della pubblicazione: alle 12:35 il Brent aveva ampliato il recupero fino a 86,04 dollari con più 2,7% e il WTI a 82,06, ma alle 15:10, dopo le parole del segretario al Tesoro Bessent su un’intesa per riaprire lo stretto possibile lo stesso giorno o il mercoledì, Brent e WTI erano a 80,66 e 76,76 dollari con circa meno 4%, cioè sotto i livelli da cui erano risaliti. Alle 18:25 dello stesso 4 agosto il Brent era intorno a 79,8 e il WTI a 76; l’esito registrato il 5 agosto alle 09:20 lo dà sceso ancora a 78,85-79 con il WTI intorno a 75; il 5 agosto alle 19:15 stava a 79,34 e 75,42 e il 6 agosto alle 08:40 a 79,08 e 74,69, terzo giorno di fila di ribasso. L’analisi del 10 agosto alle 11:00 conferma retrospettivamente che il 4 agosto una dichiarazione di Bessent sullo stesso tema aveva fatto scendere il Brent di circa il 4%. Va detto per onestà che il motore del ritorno sui minimi è stato l’apertura diplomatica americana e non un giudizio del mercato sull’incidente, ma il fatto di prezzo richiesto dalla condizione si è verificato entro poche ore dalla pubblicazione e senza alcuna ambiguità sul termine, che era rapidamente.',
      },
    ],
    what: 'Nella stessa seduta della pubblicazione il prezzo del petrolio ha fatto l’opposto di quello che la lettura assumeva: l’oro stava a circa 4.060 dollari alle 08:45 e a 4.053 alle 12:35 mentre il Brent ampliava il recupero fino a 86,04, ma alle 15:10, dopo l’apertura di Bessent su una possibile riapertura dello stretto, Brent e WTI erano a 80,66 e 76,76 dollari con circa meno 4%, sotto gli 83,77 e 80,34 da cui erano risaliti; il 6 agosto il Brent toccava 79,08 e il WTI 74,69. Sulle altre due condizioni l’analisi ha tenuto: nessun chiarimento ufficiale ha ridimensionato l’attacco, e anzi il 7 agosto ADNOC dichiarava quindici proprie navi colpite dall’inizio del conflitto con un morto e venti feriti, mentre il 14 agosto se ne contavano almeno sedici dal 28 febbraio. Un accordo verificabile fra Stati Uniti e Iran non è mai arrivato: al 18 agosto Reuters riferisce solo di possibili contatti indiretti tramite un intermediario curdo senza alcun accordo, e i transiti a Hormuz sono passati da otto navi il 5 agosto a sei il 17 agosto, contro oltre 130 al giorno prima del conflitto.',
  },
  {
    ...
    conditions: [
      {
        condition: 'Un forte calo dei rendimenti dopo il JOLTS.',
        triggered: true,
        evidence:
          'Il JOLTS di giugno esce alle 16:00 del 4 agosto a 7,359 milioni contro i 7,440 attesi, con maggio rivisto al ribasso a 7,537 e il tasso di posti vacanti dal 4,6% al 4,4%: sono i numeri dell’analisi delle 16:30 del 4 agosto, intitolata «JOLTS piu’ debole delle attese: oro su, rendimenti giu’». Sul decennale il calo si misura, ma non e’ lineare: l’analisi delle 12:35 dello stesso giorno, cioe’ prima del dato, registra il Treasury a dieci anni al 4,705% dopo un rialzo di 2,2 punti base; quella delle 16:30 lo da’ «sceso dall’area del 4,70% verso circa il 4,64%»; quella delle 20:05 lo riporta pero’ risalito al 4,66%, cioe’ due punti base sopra la rilevazione precedente; e l’esito registrato in outcomes.data.ts per l’analisi delle 20:05, controllato alle 08:30 del 5 agosto, scrive «il decennale e’ sceso ancora, dal 4,66% verso il 4,62%». Il saldo e’ di circa 6,5 punti base nella mezz’ora dopo il dato e di circa 8,5 entro la mattina seguente, con un rimbalzo intermedio: e’ un calo reale ma non una discesa continua, e va detto perche’ il primo passaggio lo aveva descritto come «mai invertito» citando i numeri che lo smentiscono. Sul trentennale — la scadenza di cui parla questa analisi, citata a circa il 5,25%, e quella indicata dall’analisi stessa come il punto della pressione sulla curva — nessuna delle analisi pubblicate fra il 4 e il 9 agosto riporta una rilevazione: l’unico riferimento e’ quello dell’analisi del 5 agosto alle 15:25, che ricorda «il trentennale al 5,25%» come livello di partenza per parlare delle emissioni del Tesoro, e quando il numero riappare misurato in archivio, il 10 e l’11 agosto, sta al 5,28%, cioe’ piu’ alto. La condizione e’ quindi scattata sul testo dichiarato, che parla di «rendimenti» senza qualificare la scadenza, ma la prova e’ diretta solo sul decennale e resta indiretta e contraria sulla parte lunga che l’analisi metteva al centro.',
      },
      {
        condition: 'Un dollaro in discesa.',
        triggered: true,
        evidence:
          'Al momento della pubblicazione, alle 11:15 del 4 agosto, l’analisi si attendeva un dollaro «tendenzialmente sostenuto», e l’analisi delle 12:35 dello stesso giorno registra il Dollar Index «tornato appena sopra 100». Dopo il JOLTS il numero cambia segno: l’analisi delle 16:30 del 4 agosto scrive che il DXY è «tornato sotto quota 100, intorno a 99,89», e la stessa analisi mette la debolezza del dollaro fra le tre gambe della reazione coerente. La discesa prosegue nei giorni successivi: l’analisi del 5 agosto alle 17:30 descrive il dollaro «indebolito» e quella del 5 agosto alle 23:10 lo rileva a 99,75, ancora sotto quota 100. Il movimento da poco sopra 100 a 99,89 lo stesso pomeriggio e a 99,75 il giorno dopo è misurato e va nella direzione della condizione.',
      },
      {
        condition: 'Un XAU/USD capace di superare con decisione i massimi della mattinata.',
        triggered: true,
        evidence:
          'I massimi della mattinata del 4 agosto risultano dalle due analisi pubblicate prima di questa: quella delle 08:45 dà l’oro «vicino ai 4.060 dollari» con circa più 0,2%, e questa stessa analisi delle 11:15 lo colloca «poco sopra i 4.062 dollari»; alle 12:35 il metallo era anzi già ridisceso a circa 4.053. Il riferimento mattutino è quindi l’area dei 4.062 dollari. Dopo il JOLTS l’analisi delle 16:30 del 4 agosto lo dà «salito verso i 4.080-4.085 dollari», e quella delle 20:05 dello stesso giorno registra lo spot a circa 4.092 dollari con circa più 1% e il future Comex in chiusura a 4.095,40 con più 1,53%, aggiungendo che «non è rimasto un movimento momentaneo subito dopo il JOLTS: l’oro ha mantenuto e ampliato i guadagni per tutta la seduta». Il superamento è quindi di circa trenta dollari, cioè lo 0,7% sopra il massimo mattutino, dentro la stessa giornata, e si estende: l’analisi del 5 agosto alle 08:35 rileva XAU/USD «verso i 4.127 dollari», circa più 1,3%, cioè sessantacinque dollari sopra i massimi della mattina precedente.',
      },
    ],
    what: 'Tutte e tre le condizioni di invalidazione sono scattate, e sono scattate nel giro delle quattro ore successive alla pubblicazione delle 11:15 del 4 agosto. Il JOLTS delle 16:00 esce debole (7,359 milioni contro 7,440 attesi, maggio rivisto a 7,537, tasso di posti vacanti dal 4,6% al 4,4%) e il decennale scende dal 4,705% delle 12:35 al 4,64% delle 16:30 e poi al 4,62% della mattina del 5 agosto, mentre il Dollar Index passa da poco sopra 100 a 99,89 e l’oro rompe i massimi mattutini dei 4.062 dollari salendo a 4.080-4.085, poi a 4.092 spot con il future Comex in chiusura a 4.095,40 (più 1,53%) e a circa 4.127 il mattino dopo. L’unico numero che resta senza riscontro nella finestra è proprio il trentennale al 5,25% che dà il titolo all’analisi: nessuna analisi fra il 4 e il 9 agosto lo rileva, e quando riappare misurato il 10 e l’11 agosto sta al 5,28%, cioè più in alto.',
    lesson:
      'È il primo verdetto di invalidazione del registro, ed è arrivato dall’analisi con le condizioni peggio scritte. Le tre dicevano «un forte calo dei rendimenti», «un dollaro in discesa», «un XAU/USD capace di superare con decisione i massimi della mattinata»: nessuna conteneva un numero, e due contenevano un avverbio — «forte», «con decisione» — che chi ricontrolla può tarare come vuole. Sono scattate tutte e tre, e sarebbero potute non scattare nessuna con gli stessi dati, perché a decidere non è il mercato ma chi legge. Una condizione senza soglia numerica non falsifica un’analisi: la consegna al giudizio di chi la rilegge, che è esattamente la cosa da cui il registro dovrebbe proteggere. Da qui in avanti il numero va messo anche quando sembra arbitrario, perché un numero arbitrario dichiarato prima vale più di un aggettivo tarato dopo.',
  },
  {
    ...
    conditions: [
      {
        condition: 'Il petrolio restituisce il recupero.',
        triggered: true,
        evidence:
          'L’analisi delle 15:10 del 4 agosto, cioè due ore e trentacinque minuti dopo la pubblicazione, registra che Brent e WTI sono passati dal recupero della mattina a un calo di circa il 4%, con il Brent a 80,66 dollari e il WTI a 76,76 dopo le dichiarazioni del segretario al Tesoro Bessent su una possibile intesa per riaprire lo Stretto di Hormuz. L’analisi delle 20:05 dello stesso 4 agosto conferma la chiusura del movimento con il Brent a 80,47 dollari (-3,9%) e il WTI a 76,67 (-4,6%). Il recupero di +2,7% citato a 86,04 dollari non è stato solo restituito ma superato al ribasso di oltre cinque dollari e mezzo nella stessa seduta.',
      },
      {
        condition: 'Il decennale torna sotto il 4,68% circa.',
        triggered: true,
        evidence:
          'L’analisi sul JOLTS pubblicata alle 16:30 del 4 agosto, dopo il dato delle 16:00 uscito a 7,359 milioni contro i 7,440 attesi, registra il rendimento del Treasury decennale sceso dall’area del 4,70% verso circa il 4,64%, quindi quattro punti base sotto la soglia dichiarata. L’analisi delle 20:05 dello stesso giorno lo colloca a circa 4,66%, ancora sotto il 4,68%, e quella delle 08:35 del 5 agosto lo dà in ulteriore discesa verso il 4,62%. Il livello di partenza citato nell’analisi era 4,705%.',
      },
      {
        condition: 'Il Dollar Index scende sotto quota 100.',
        triggered: true,
        evidence:
          'La stessa analisi delle 16:30 del 4 agosto registra il DXY tornato sotto quota 100, intorno a 99,89, contro il valore appena sopra 100 citato alle 12:35. Il rientro non è stato momentaneo: l’esito registrato nell’analisi del 5 agosto sull’ADP riporta, su dati Investing.com, un Dollar Index che il 6 agosto si muove fra 99,510 e 99,692 con chiusura precedente a 99,546, cioè un massimo di finestra che resta trentuno centesimi sotto quota 100.',
      },
      {
        condition: 'L’oro supera con decisione l’area dei 4.100 dollari.',
        triggered: true,
        evidence:
          'Nella stessa seduta del 4 agosto l’oro si è fermato poco sotto: l’analisi delle 20:05 lo dà a circa 4.092 dollari con il future Comex in chiusura a 4.095,40, quindi l’area dei 4.100 non era ancora superata a fine giornata. Il superamento arriva il giorno dopo: l’analisi delle 08:35 del 5 agosto registra XAU/USD verso i 4.127 dollari (circa +1,3%), quella delle 10:30 parla di una corsa verso i 4.175 e quella delle 17:30 dello stesso 5 agosto lo dà a circa 4.199,8 dollari, oltre +3% nella seduta e massimo dal 22 giugno. Rispetto ai 4.053 dollari citati alla pubblicazione sono quasi centocinquanta dollari in un giorno e mezzo, con l’intero comparto dei preziosi in rialzo: il carattere deciso del superamento è quindi documentato, con l’avvertenza che è maturato oltre la giornata di pubblicazione, entro comunque l’orizzonte breve dichiarato dall’analisi.',
      },
    ],
    what: 'L’analisi delle 12:35 del 4 agosto 2026 fotografava il Brent a 86,04 dollari (circa +2,7%), il WTI a 82,06, il decennale statunitense al 4,705%, il Dollar Index appena sopra quota 100 e l’oro quasi fermo a 4.053 dollari, e da questa combinazione ricavava un’impostazione neutrale-ribassista sull’orizzonte breve. Nelle due ore e mezza successive il quadro si è capovolto interamente: alle 15:10 le parole di Bessent su una possibile riapertura di Hormuz avevano portato il Brent a 80,66 e il WTI a 76,76 (circa -4% ciascuno), e alle 16:00 il JOLTS di giugno a 7,359 milioni contro i 7,440 attesi ha spinto il decennale dall’area del 4,70% verso il 4,64% e il Dollar Index sotto quota 100, a 99,89. L’oro è salito a 4.092 dollari in serata (future Comex in chiusura a 4.095,40, +1,53%), ha superato i 4.100 la mattina del 5 agosto a circa 4.127 e ha accelerato fino a circa 4.199,8 dollari nel pomeriggio dello stesso giorno, massimo dal 22 giugno: tutti e quattro i riferimenti su cui poggiava la lettura si sono girati nel giro di circa ventiquattro ore.',
  },
  {
    ...
    conditions: [
      {
        condition: 'Il fallimento delle trattative o una nuova smentita netta da parte dell’Iran.',
        triggered: true,
        evidence:
          'La condizione è disgiuntiva e a scattare è il secondo disgiunto. Le trattative non sono fallite: al 10 agosto l’archivio registra ancora progressi tecnici con l’Oman. La smentita netta però c’è, e non è del 4 agosto: l’analisi delle 18:25 di quel giorno riporta solo i termini negoziali secondo Reuters e anzi annota che Teheran ha attenuato la richiesta iniziale di controllo totale. Il primo elemento utile è del 5 agosto alle 8:35 (hormuz-non-ha-riaperto-otto-navi-contro-130-al-giorno.md): l’Iran continua a negare negoziati diretti con Washington, con i transiti fermi a otto navi contro le 130-140 al giorno di prima del conflitto. Il 6 agosto alle 17:15 (teheran-i-colloqui-con-oman-non-sono-la-riapertura.md) un esponente della commissione Sicurezza nazionale del Parlamento iraniano dichiara che i colloqui con l’Oman riguardano la gestione delle rotte e non la riapertura dello Stretto nel senso prospettato dagli Stati Uniti, e Teheran subordina la piena riapertura alla fine del blocco statunitense dei porti; quella stessa analisi però dichiara di non sapere se sia la posizione del governo. Lo diventa l’8 agosto alle 17:30 (la-riapertura-ha-un-prezzo-non-sul-tavolo-dell-oman.md), ed è questa la prova che porta la condizione: il portavoce delle Guardie Rivoluzionarie Hossein Mohebbi dice che la riapertura non dipende dai negoziati con l’Oman ma dall’accettazione americana delle condizioni iraniane, in risposta diretta a un funzionario statunitense che poche ore prima si diceva in attesa di un accordo a breve, e il ministro degli Esteri Abbas Araqchi conferma l’intesa tecnica su una nuova rotta aggiungendo che la riapertura dipende da altre condizioni, fra cui una compensazione statunitense. È la negazione esplicita, da parte del governo, proprio della cosa su cui poggiava l’analisi. L’intesa che Bessent dava per possibile «oggi o mercoledì» non è arrivata: il 6 agosto alle 18:47 l’archivio annota che la dichiarazione congiunta Iran-Oman attesa per il 5 agosto non è stata emessa e che i transiti restano otto.',
      },
      {
        condition: 'Ulteriori attacchi alle navi.',
        triggered: true,
        evidence:
          'Gli attacchi sono proseguiti senza interruzione a partire dal giorno dopo. L’analisi del 5 agosto alle 13:20 riporta che gli Houthi hanno dichiarato di aver colpito con un missile una petroliera saudita vicino al porto di Yanbu, sul Mar Rosso, con il Brent che reagisce salendo a 80,87 dollari, circa più 1,9%. L’analisi del 7 agosto alle 17:25 riporta la dichiarazione di ADNOC secondo cui quindici sue navi sono state colpite da missili o droni nello Stretto di Hormuz dall’inizio del conflitto, tre soltanto in quella settimana, con un morto e venti feriti fra gli equipaggi; nella stessa giornata il Brent gira da 81,66 dollari e meno 1,01% alle 14:57 a 83,33 dollari e più 1,02%. L’analisi dell’8 agosto alle 17:30 registra l’accusa degli Emirati all’Iran di aver lanciato un missile contro una nave collegata ad ADNOC in transito nello Stretto, senza feriti in quell’episodio. L’11 agosto alle 17:15 arriva il primo attacco mortale della fase, con almeno tre membri dell’equipaggio uccisi su una nave a Bab el-Mandeb. Il 14 agosto alle 10:20 gli Emirati accusano l’Iran di aver colpito due navi di ADNOC la sera di giovedì 13 nello Stretto, secondo episodio in meno di una settimana e almeno il sedicesimo dal 28 febbraio, nella stessa seduta in cui il Brent scende del 2,1% a 87,07 dollari. Il 18 agosto alle 8:40 UK Maritime Trade Operations segnala un’altra nave colpita da un proiettile non identificato mentre usciva dallo Stretto, con la sala macchine danneggiata.',
      },
      {
        condition: 'Un forte rimbalzo del petrolio.',
        triggered: true,
        evidence:
          'Il rimbalzo c’è stato ed è stato ampio, misurato sugli stessi riferimenti usati dall’analisi. Il punto di partenza è il Brent a 80,66 dollari e il WTI a 76,76 citati dall’analisi del 4 agosto alle 15:10, con chiusura del 5 agosto a 79,45 dollari registrata dall’archivio. Il 5 agosto alle 13:20 il Brent è già risalito a 80,87 dollari, circa più 1,9%, sull’attacco di Yanbu. Il 6 agosto alle 18:47 il Brent è a 82,74 dollari alle 18:22 con un massimo di giornata a 82,91 e un rialzo del 3,98% dalla chiusura di 79,45: è la soglia degli 82 dollari, scritta come condizione di invalidazione da tre analisi del 5 e 6 agosto e come tacca rossa dell’indicatore operativo, che cade per la prima volta. Il 7 agosto alle 17:25 il Brent è a 83,33 dollari con più 1,02%; il 10 agosto alle 17:15 arriva a 86,11 dollari con più 3,1%, che sulla serie usata dall’archivio valgono circa 84,7 e superano anche la tacca degli 84 dichiarata il 5 agosto; l’11 agosto alle 10:45 tocca circa 89,12 dollari con il WTI a 83,48, nuovi massimi della fase; il 18 agosto alle 8:40 estende a 91,49 dollari con più 0,7%. Dal livello di partenza di 80,66 dollari al 91,49 del 18 agosto sono circa tredici punti percentuali, e la parte decisiva del movimento si è compiuta entro quarantotto ore dalla pubblicazione. Nella stessa direzione si sono mossi i rendimenti, che erano il canale su cui l’analisi contava: il decennale dal 4,64% del 4 agosto al 4,67% del 6, al 4,696% di massimo intraday del 10 e al 4,726% del 18 agosto.',
      },
      {
        condition:
        ...
        triggered: false,
        evidence:
          'La condizione aveva un termine preciso, le 16:00 dello stesso 4 agosto, ed è stata verificata dentro quel termine: il dato è uscito nella direzione opposta. L’analisi pubblicata il 4 agosto alle 16:30, mezz’ora dopo la diffusione, registra le offerte di lavoro statunitensi di giugno a 7,359 milioni contro i 7,440 milioni attesi e i 7,537 milioni di maggio, questi ultimi rivisti al ribasso, con il tasso di posti vacanti sceso dal 4,6% al 4,4% e le assunzioni ferme a 5,3 milioni. Non solo il JOLTS non è stato molto forte, ma è stato più debole delle attese. Anche la seconda metà della condizione, la risalita di dollaro e rendimenti, non si è verificata nella finestra: la stessa analisi registra XAU/USD salito verso i 4.080-4.085 dollari, il decennale sceso dall’area del 4,70% verso circa il 4,64% e il Dollar Index di nuovo sotto quota 100 a circa 99,89. Va segnalato che dollaro e rendimenti sono risaliti nei giorni successivi — decennale al 4,67% il 6 agosto e al 4,726% il 18 — ma per effetto del rimbalzo del greggio e della vicenda Hormuz, non del JOLTS, che è il dato nominato dalla condizione.',
      },
    ],
    what: 'Il 4 agosto alle 15:10 l’analisi fotografava Brent a 80,66 e WTI a 76,76 dollari, entrambi in calo di circa il 4% dopo l’apertura di Bessent a un’intesa su Hormuz «oggi o mercoledì», e portava il bias su XAU/USD a neutrale con lieve inclinazione rialzista attraverso il canale inflazione-rendimenti. Il test immediato è andato nel verso sperato: il JOLTS delle 16:00 è uscito a 7,359 milioni contro 7,440 attesi, con il decennale sceso dall’area del 4,70% verso il 4,64%, il DXY a 99,89 e l’oro verso 4.080-4.085 dollari. Le altre tre condizioni sono però scattate tutte nel giro di pochi giorni: l’Iran ha smentito che il tavolo con l’Oman sia la riapertura (6 e 8 agosto), gli attacchi alle navi sono proseguiti fino al sedicesimo episodio della sera del 13 agosto, e il Brent è risalito a 82,74 dollari il 6 agosto, 86,11 il 10 e 91,49 il 18, cioè circa il 13% sopra il livello da cui l’analisi partiva.',
  },
  {
    ...
    conditions: [
      {
        condition: 'XAU/USD che non riesce a mantenersi sopra i 4.070 dollari circa.',
        triggered: false,
        evidence:
          'Il metallo non è mai tornato sotto quel livello nella finestra dell’orizzonte intraday dichiarato. L’analisi delle 20:05 del 4 agosto, cioè tre ore e mezza dopo la pubblicazione, registra XAU/USD a circa 4.092 dollari con un guadagno di circa l’1% e il future Comex in chiusura a 4.095,40 dollari con più 1,53%. La mattina del 5 agosto l’analisi sui transiti a Hormuz registra circa 4.127 dollari con più 1,3%, e il pomeriggio del 5 agosto alle 17:30 l’analisi sull’oro che sfiora i 4.200 dà circa 4.199,8 dollari, oltre più 3% nella seduta e massimo dal 22 giugno. Lo stesso numero compare come condizione dichiarata dall’analisi delle 20:05 del 4 agosto e il suo esito registrato in outcomes.data.ts, controllato il 5 agosto alle 08:30, dice testualmente che non c’è stato nessun ritorno sotto quel livello e che dai 4.092 dollari della pubblicazione il metallo è salito fino a circa 4.127. Il minimo osservabile nella finestra resta quindi almeno dieci dollari sopra i 4.070.',
      },
      {
        condition: 'Il rendimento del decennale che torna sopra il 4,70%.',
        triggered: false,
        evidence:
          'Nella finestra dell’orizzonte breve il decennale è andato nella direzione opposta. Alle 20:05 del 4 agosto era arretrato a circa 4,66% dall’area del 4,70%, la mattina del 5 agosto a circa 4,62%, e la chiusura del 5 agosto è 4,617% secondo il numero registrato in outcomes.data.ts per l’analisi dell’ADP. Il 6 agosto l’escursione riportata sulla stessa fonte è fra 4,609% e 4,653%, con 4,642% alle 15:27 rilevato su Investing.com: il massimo di quella giornata resta 4,7 punti base sotto la soglia. Il ritorno sopra il 4,70% è arrivato molto più tardi: il 10 agosto in serata il decennale ha toccato 4,703% e l’11 agosto mattina ha raggiunto un massimo di 4,716% con rilevazione a circa 4,712%. Sono sei e sette giorni dopo la pubblicazione, cioè fuori dall’orizzonte intraday dichiarato dall’analisi, e per questa ragione non fanno scattare la condizione.',
      },
      {
        condition: 'Il DXY nuovamente sopra quota 100.',
        triggered: false,
        evidence:
          'Il Dollar Index è rimasto sotto quota 100 per tutta la finestra dell’orizzonte breve, che il sito stesso definisce «Intraday — prossimi minuti o ore» (src/app/core/data/signal.data.ts). Partiva da 99,89 alla pubblicazione delle 16:30 del 4 agosto. L’analisi delle 13:20 del 5 agosto sull’attacco houthi lo colloca a circa 99,85, sempre debole e sotto quota 100; quella delle 23:10 del 5 agosto su Cook lo dà a 99,75, ancora sotto la soglia anche dopo l’intervento restrittivo. Per il 6 agosto l’esito registrato in outcomes.data.ts (righe 1799-1801) riporta rilevazioni Investing.com fra 99,510 e 99,692, con chiusura precedente 99,546 e 99,660 alle 15:28: massimo di finestra 31 centesimi sotto la soglia. Fuori finestra, e solo come contesto, quota 100 non viene comunque mai superata nell’archivio successivo: la lettura più alta che compare è un massimo di 99,990 il 13 agosto (il 12 agosto chiusura 99,899 con massimo 99,910), e il 17 agosto l’indice scende a 99,42, minimo da giugno, chiudendo a 99,51.',
      },
      {
        condition:
        ...
        triggered: false,
        evidence:
          'La condizione è composta e chiede due cose insieme: sviluppi diplomatici concreti E una forte riduzione della domanda di bene rifugio. Nessuna delle due si realizza nella finestra. Sulla prima gamba, alle 18:25 del 4 agosto l’analisi sulle richieste iraniane registra che i termini operativi non risultano concordati, e il suo esito controllato il 5 agosto alle 09:20 conferma che a quindici ore non c’era nessun accordo definitivo. Il fatto più avanzato è l’annuncio delle 19:15 del 5 agosto sulle coordinate geografiche concordate fra Iran e Oman: la stessa analisi lo qualifica come il primo annuncio che produce un oggetto tecnico invece di una frase, ma anche come «non ancora il numero che questo archivio ha scelto di guardare», con quattro punti irrisolti (controllo del traffico in uscita, tariffe di transito, garanzie di sicurezza, opposizione statunitense) e il conteggio dei transiti non mosso di una unità. Quel conteggio è la misura: la mattina del 5 agosto sono otto transiti contro le 130-140 navi al giorno precedenti al conflitto, circa il 90% in meno. La dichiarazione congiunta non è mai stata emessa — l’esito in outcomes.data.ts (righe 1629-1636) constata che a due giorni di distanza il testo risulta ancora in revisione e in fase finale e riguarda comunque una rotta temporanea di sessanta giorni, non la riapertura. Sulla seconda gamba la smentita è diretta: la domanda di rifugio non si è ridotta, l’oro è salito dai 4.080-4.085 dollari della pubblicazione a circa 4.199,8 il pomeriggio del 5 agosto, oltre più 3% e massimo dal 22 giugno.',
      },
    ],
    what: 'L’analisi, pubblicata il 4 agosto 2026 alle 16:30 con XAU/USD verso i 4.080-4.085 dollari, il decennale a circa 4,64% e il DXY a 99,89, dichiarava un bias moderatamente rialzista sull’orizzonte intraday dopo un JOLTS di giugno a 7,359 milioni contro 7,440 attesi. Nella finestra dichiarata il movimento è andato nel verso previsto e nessuna delle quattro condizioni è scattata: l’oro ha esteso il rialzo a circa 4.092 dollari la sera stessa (future Comex in chiusura a 4.095,40, più 1,53%), a circa 4.127 la mattina del 5 agosto e a circa 4.199,8 il pomeriggio del 5, mentre il decennale scendeva al 4,66% e poi al 4,617% in chiusura del 5 agosto e il Dollar Index restava a 99,85 il 5 agosto e fra 99,510 e 99,692 il 6. Sul fronte diplomatico non è arrivato nulla di concreto: nessun accordo, nessuna dichiarazione congiunta Iran-Oman, e otto transiti a Hormuz il 5 agosto contro le 130-140 navi al giorno precedenti al conflitto.',
  },
];
